...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
        ...
        while (true) {
            ...
            if (obj != null && obj != StateFlowKt.PENDING) {
                if (obj == StateFlowKt.NONE) {
                    if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, (Object) this, obj, (Object) StateFlowKt.PENDING)) {
                        return;
                    }
                } else if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, (Object) this, obj, (Object) StateFlowKt.NONE)) {
                    Result.Companion companion = Result.Companion;
                    ((CancellableContinuationImpl) obj).resumeWith(Result.m328constructorimpl(Unit.INSTANCE));
                    return;
                }
            } else {
                return;
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(_state$FU.get(this) instanceof CancellableContinuationImpl))) {
            if (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, (Object) this, (Object) StateFlowKt.NONE, (Object) cancellableContinuation)) {
                ...
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m328constructorimpl(Unit.INSTANCE));
            }
