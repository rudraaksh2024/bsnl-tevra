...
final class StateFlowImpl<T> extends AbstractSharedFlow<StateFlowSlot> implements MutableStateFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:34:0x00b2 A[Catch:{ all -> 0x00f5 }] */
    /* JADX WARNING: Removed duplicated region for block: B:40:0x00c1 A[Catch:{ all -> 0x00f5 }] */
    /* JADX WARNING: Removed duplicated region for block: B:41:0x00c3 A[Catch:{ all -> 0x00f5 }] */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00d6 A[Catch:{ all -> 0x00f5 }, RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:45:0x00d7 A[Catch:{ all -> 0x00f5 }] */
    /* JADX WARNING: Removed duplicated region for block: B:49:0x00e2 A[Catch:{ all -> 0x00f5 }] */
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r11, kotlin.coroutines.Continuation<?> r12) {
        ...
        L_0x0067:
            ...
            kotlin.ResultKt.throwOnFailure(r12)     // Catch:{ all -> 0x00f5 }
            goto L_0x0099
        L_0x0079:
            ...
            r2 = r12
            kotlinx.coroutines.flow.StateFlowSlot r2 = (kotlinx.coroutines.flow.StateFlowSlot) r2
            boolean r12 = r11 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector     // Catch:{ all -> 0x00f5 }
            if (r12 == 0) goto L_0x0099
            r12 = r11
            kotlinx.coroutines.flow.SubscribedFlowCollector r12 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r12     // Catch:{ all -> 0x00f5 }
            r0.L$0 = r10     // Catch:{ all -> 0x00f5 }
            r0.L$1 = r11     // Catch:{ all -> 0x00f5 }
            r0.L$2 = r2     // Catch:{ all -> 0x00f5 }
            r0.label = r6     // Catch:{ all -> 0x00f5 }
            java.lang.Object r12 = r12.onSubscription(r0)     // Catch:{ all -> 0x00f5 }
            if (r12 != r1) goto L_0x0099
            return r1
        L_0x0099:
            kotlin.coroutines.CoroutineContext r12 = r0.getContext()     // Catch:{ all -> 0x00f5 }
            kotlinx.coroutines.Job$Key r6 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x00f5 }
            kotlin.coroutines.CoroutineContext$Key r6 = (kotlin.coroutines.CoroutineContext.Key) r6     // Catch:{ all -> 0x00f5 }
            kotlin.coroutines.CoroutineContext$Element r12 = r12.get(r6)     // Catch:{ all -> 0x00f5 }
            kotlinx.coroutines.Job r12 = (kotlinx.coroutines.Job) r12     // Catch:{ all -> 0x00f5 }
            r6 = r11
            r11 = r12
            r12 = r3
        L_0x00aa:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r7 = _state$FU     // Catch:{ all -> 0x00f5 }
            java.lang.Object r7 = r7.get(r10)     // Catch:{ all -> 0x00f5 }
            if (r11 == 0) goto L_0x00b5
            kotlinx.coroutines.JobKt.ensureActive((kotlinx.coroutines.Job) r11)     // Catch:{ all -> 0x00f5 }
        L_0x00b5:
            if (r12 == 0) goto L_0x00bd
            boolean r8 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r12, (java.lang.Object) r7)     // Catch:{ all -> 0x00f5 }
            if (r8 != 0) goto L_0x00dc
        L_0x00bd:
            kotlinx.coroutines.internal.Symbol r12 = kotlinx.coroutines.flow.internal.NullSurrogateKt.NULL     // Catch:{ all -> 0x00f5 }
        ...
        L_0x00c4:
            r0.L$0 = r10     // Catch:{ all -> 0x00f5 }
            r0.L$1 = r6     // Catch:{ all -> 0x00f5 }
            r0.L$2 = r2     // Catch:{ all -> 0x00f5 }
            r0.L$3 = r11     // Catch:{ all -> 0x00f5 }
            r0.L$4 = r7     // Catch:{ all -> 0x00f5 }
            r0.label = r5     // Catch:{ all -> 0x00f5 }
            java.lang.Object r12 = r6.emit(r12, r0)     // Catch:{ all -> 0x00f5 }
        ...
        L_0x00da:
            ...
            r10 = r7
        L_0x00dc:
            boolean r7 = r2.takePending()     // Catch:{ all -> 0x00f5 }
            if (r7 != 0) goto L_0x00aa
            r0.L$0 = r10     // Catch:{ all -> 0x00f5 }
            r0.L$1 = r6     // Catch:{ all -> 0x00f5 }
            r0.L$2 = r2     // Catch:{ all -> 0x00f5 }
            r0.L$3 = r11     // Catch:{ all -> 0x00f5 }
            r0.L$4 = r12     // Catch:{ all -> 0x00f5 }
            r0.label = r4     // Catch:{ all -> 0x00f5 }
            java.lang.Object r7 = r2.awaitPending(r0)     // Catch:{ all -> 0x00f5 }
