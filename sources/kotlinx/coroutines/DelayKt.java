...
public final class DelayKt {
    ...
    public static final Object m1832delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1833toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1833toDelayMillisLRDsOJo(long j) {
        if (Duration.m1658compareToLRDsOJo(j, Duration.Companion.m1762getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1677getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
