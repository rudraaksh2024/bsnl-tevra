...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    private final void update$atomicfu(AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, Function1<Object, ? extends Object> function1, Object obj) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, obj, obj2, (Object) function1.invoke(obj2)));
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x0057 A[PHI: r6 
      PHI: (r6v2 java.lang.Object) = (r6v4 java.lang.Object), (r6v1 java.lang.Object) binds: [B:18:0x0054, B:10:0x0029] A[DONT_GENERATE, DONT_INLINE], RETURN] */
        ...
        while (true) {
            ...
            if (obj3 instanceof CancellableContinuation) {
                ...
                if (findClause == null) {
                    ...
                    if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, (Object) this, obj3, (Object) findClause)) {
                ...
                if (Intrinsics.areEqual(obj3, (Object) SelectKt.STATE_REG)) {
                    if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, (Object) this, obj3, (Object) CollectionsKt.listOf(obj))) {
                        return 1;
                    }
                } else if (!(obj3 instanceof List)) {
                    throw new IllegalStateException(("Unexpected state: " + obj3).toString());
                } else if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, (Object) this, obj3, (Object) CollectionsKt.plus((Collection) obj3, obj))) {
                    return 1;
                }
            }
        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v0, resolved type: kotlinx.coroutines.selects.SelectImplementation<R>$ClauseData} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v1, resolved type: kotlinx.coroutines.selects.SelectImplementation<R>$ClauseData} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v5, resolved type: kotlinx.coroutines.selects.SelectImplementation<R>$ClauseData} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final kotlinx.coroutines.selects.SelectImplementation<R>.ClauseData findClause(java.lang.Object r4) {
        /*
            r3 = this;
            java.util.List<kotlinx.coroutines.selects.SelectImplementation<R>$ClauseData> r3 = r3.clauses
            r0 = 0
        ...
        L_0x000c:
            ...
            java.lang.Object r2 = r2.clauseObject
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.lang.Object processResultAndInvokeBlockRecoveringException(kotlinx.coroutines.selects.SelectImplementation<R>.ClauseData r4, java.lang.Object r5, kotlin.coroutines.Continuation<? super R> r6) {
        /*
            r3 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.selects.SelectImplementation$processResultAndInvokeBlockRecoveringException$1
            if (r0 == 0) goto L_0x0014
            r0 = r6
        ...
        L_0x0019:
            ...
            kotlin.ResultKt.throwOnFailure(r3)     // Catch:{ all -> 0x002a }
            goto L_0x0044
        L_0x002a:
            r3 = move-exception
            goto L_0x0045
        ...
        L_0x0034:
            ...
            java.lang.Object r3 = r4.processResult(r5)     // Catch:{ all -> 0x002a }
            r0.label = r2     // Catch:{ all -> 0x002a }
            java.lang.Object r3 = r4.invokeBlock(r3, r0)     // Catch:{ all -> 0x002a }
        ...
        L_0x0045:
            ...
            boolean r4 = r0 instanceof kotlin.coroutines.jvm.internal.CoroutineStackFrame
            if (r4 != 0) goto L_0x0050
            throw r3
        L_0x0050:
            kotlin.coroutines.jvm.internal.CoroutineStackFrame r0 = (kotlin.coroutines.jvm.internal.CoroutineStackFrame) r0
            java.lang.Throwable r3 = kotlinx.coroutines.internal.StackTraceRecoveryKt.recoverFromStackFrame(r3, r0)
            throw r3
        L_0x0057:
            throw r3
        */
    ...
    public void invoke(Throwable th) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, (Object) this, obj, (Object) SelectKt.STATE_CANCELLED));
        List<SelectImplementation<R>.ClauseData> list = this.clauses;
        if (list != null) {
    ...
    public final Object waitUntilSelected(Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.STATE_REG) {
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(state$FU, (Object) this, obj, (Object) cancellableContinuation)) {
                    cancellableContinuation.invokeOnCancellation(this);
                    break;
                }
            } else if (obj instanceof List) {
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(state$FU, (Object) this, obj, (Object) SelectKt.STATE_REG)) {
                    List list = (List) obj;
