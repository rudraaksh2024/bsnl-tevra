...
public class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(Waiter waiter) {
        ...
        do {
            ...
            if (SegmentOrClosed.m1910isClosedimpl(findSegmentInternal)) {
                break;
            }
            Segment r10 = SegmentOrClosed.m1908getSegmentimpl(findSegmentInternal);
            while (true) {
                ...
                if (segment.id >= r10.id) {
                    ...
                    continue;
                    break;
                } else if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, (Object) this, (Object) segment, (Object) r10)) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m1908getSegmentimpl(findSegmentInternal);
        int access$getSEGMENT_SIZE$p2 = (int) (andIncrement % ((long) SemaphoreKt.SEGMENT_SIZE));
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(semaphoreSegment2.getAcquirers(), access$getSEGMENT_SIZE$p2, (Object) null, (Object) waiter2)) {
            waiter2.invokeOnCancellation(semaphoreSegment2, access$getSEGMENT_SIZE$p2);
            return true;
        }
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(semaphoreSegment2.getAcquirers(), access$getSEGMENT_SIZE$p2, (Object) SemaphoreKt.PERMIT, (Object) SemaphoreKt.TAKEN)) {
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        do {
            ...
            Segment r9 = SegmentOrClosed.m1908getSegmentimpl(findSegmentInternal);
            while (true) {
                Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                if (segment.id >= r9.id) {
                    break;
                    ...
                    continue;
                    break;
                } else if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, (Object) this, (Object) segment, (Object) r9)) {
                    if (segment.decPointers$kotlinx_coroutines_core()) {
                        segment.remove();
                    }
        ...
        if (andSet == null) {
            ...
            return !PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(semaphoreSegment2.getAcquirers(), access$getSEGMENT_SIZE$p2, (Object) SemaphoreKt.PERMIT, (Object) SemaphoreKt.BROKEN);
