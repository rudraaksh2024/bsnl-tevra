    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m328constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m328constructorimpl(Unit.INSTANCE);
        if (Result.m335isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1869successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1867closedJP2dKIU(Result.m331exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1854boximpl(obj3);
    }
}
