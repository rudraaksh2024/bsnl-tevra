...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int i) {
            ...
            } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.values, i, obj, (Object) null));
        ...
        public final Object putImpl(K k, V v, HashedWeakRef<K> hashedWeakRef) {
            ...
            while (true) {
                ...
                if (hashedWeakRef2 == null) {
                    if (v != null) {
                        ...
                        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.keys, index, (Object) null, (Object) hashedWeakRef)) {
                            break;
                        }
                    } else {
                        return null;
            ...
            } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.values, index, obj, (Object) v));
            return obj;
        }
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (!(obj instanceof Marked)) {
                            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(this.values, i2, obj, (Object) ConcurrentWeakMapKt.mark(obj))) {
                                break;
                            }
                        } else {
                            obj = ((Marked) obj).ref;
