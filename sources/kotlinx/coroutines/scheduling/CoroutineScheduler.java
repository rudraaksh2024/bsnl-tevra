...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    private final int getCreatedWorkers() {
        return (int) (controlState$FU.get(this) & TarConstants.MAXID);
    }
    ...
    public final void shutdown(long j) {
        ...
        if (_isTerminated$FU.compareAndSet(this, 0, 1)) {
            ...
            synchronized (this.workers) {
                i = (int) (controlState$FU.get(this) & TarConstants.MAXID);
            }
            if (1 <= i) {
                int i2 = 1;
                while (true) {
    ...
    private final int createNewWorker() {
        synchronized (this.workers) {
            ...
            int i2 = ((int) (controlState$FU.get(this) & TarConstants.MAXID)) + 1;
            if (i2 > 0 && this.workers.get(i2) == null) {
                Worker worker = new Worker(this, i2);
                this.workers.setSynchronized(i2, worker);
                if (i2 == ((int) (TarConstants.MAXID & atomicLongFieldUpdater.incrementAndGet(this)))) {
                    z = true;
                }
                if (z) {
    ...
    public String toString() {
        ...
        sb.append(", Control State {created workers= ").append((int) (TarConstants.MAXID & j)).append(", blocking tasks = ").append((int) ((BLOCKING_MASK & j) >> 21)).append(", CPUs acquired = ").append(this.corePoolSize - ((int) ((CPU_PERMITS_MASK & j) >> 42))).append("}]");
        return sb.toString();
    }
    ...
    public final class Worker extends Thread {
        ...
        private final void tryTerminateWorker() {
            ...
            synchronized (resizableAtomicArray) {
                if (!coroutineScheduler.isTerminated()) {
                    if (((int) (CoroutineScheduler.controlState$FU.get(coroutineScheduler) & TarConstants.MAXID)) > coroutineScheduler.corePoolSize) {
        ...
        private final Task trySteal(int i) {
            int i2 = (int) (CoroutineScheduler.controlState$FU.get(CoroutineScheduler.this) & TarConstants.MAXID);
            if (i2 < 2) {
                return null;
            }
