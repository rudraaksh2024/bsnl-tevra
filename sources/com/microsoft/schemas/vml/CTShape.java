...
public interface CTShape extends XmlObject {
    ...
    CTEquationXml getEquationxmlArray(int i);
    ...
    CTEquationXml insertNewEquationxml(int i);
    ...
    void setEquationxmlArray(int i, CTEquationXml cTEquationXml);
