...
public class UCrop {
    ...
    public static class Options {
        ...
        public void setAspectRatioOptions(int i, AspectRatio... aspectRatioArr) {
            ...
            throw new IllegalArgumentException(String.format(Locale.US, "Index [selectedByDefault = %d] (0-based) cannot be higher or equal than aspect ratio options count [count = %d].", new Object[]{Integer.valueOf(i), Integer.valueOf(aspectRatioArr.length)}));
        }
