...
public class FirebaseApp {
    ...
    public /* synthetic */ DataCollectionConfigStorage m283lambda$new$0$comgooglefirebaseFirebaseApp(Context context) {
    ...
    public /* synthetic */ void m284lambda$new$1$comgooglefirebaseFirebaseApp(boolean z) {
        if (!z) {
    ...
    private static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(INSTANCE, (Object) null, userUnlockReceiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(INSTANCE, (Object) null, globalBackgroundStateListener)) {
