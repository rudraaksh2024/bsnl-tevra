...
final class SequentialExecutor implements Executor {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0058, code lost:
        if (r7.workerRunningState == com.google.firebase.concurrent.SequentialExecutor.WorkerRunningState.IDLE) goto L_0x0060;
     */
    ...
    public void execute(final java.lang.Runnable r8) {
        /*
            ...
            monitor-enter(r0)
            com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r1 = r7.workerRunningState     // Catch:{ all -> 0x007d }
            com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r2 = com.google.firebase.concurrent.SequentialExecutor.WorkerRunningState.RUNNING     // Catch:{ all -> 0x007d }
            if (r1 == r2) goto L_0x0076
            com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r1 = r7.workerRunningState     // Catch:{ all -> 0x007d }
            com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r2 = com.google.firebase.concurrent.SequentialExecutor.WorkerRunningState.QUEUED     // Catch:{ all -> 0x007d }
            if (r1 != r2) goto L_0x0013
            goto L_0x0076
        L_0x0013:
            long r1 = r7.workerRunCount     // Catch:{ all -> 0x007d }
            com.google.firebase.concurrent.SequentialExecutor$1 r3 = new com.google.firebase.concurrent.SequentialExecutor$1     // Catch:{ all -> 0x007d }
            r3.<init>(r8)     // Catch:{ all -> 0x007d }
            java.util.Deque<java.lang.Runnable> r8 = r7.queue     // Catch:{ all -> 0x007d }
            r8.add(r3)     // Catch:{ all -> 0x007d }
            com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r8 = com.google.firebase.concurrent.SequentialExecutor.WorkerRunningState.QUEUING     // Catch:{ all -> 0x007d }
            r7.workerRunningState = r8     // Catch:{ all -> 0x007d }
            monitor-exit(r0)     // Catch:{ all -> 0x007d }
            r8 = 1
            r0 = 0
            java.util.concurrent.Executor r4 = r7.executor     // Catch:{ Error | RuntimeException -> 0x0050 }
            com.google.firebase.concurrent.SequentialExecutor$QueueWorker r5 = r7.worker     // Catch:{ Error | RuntimeException -> 0x0050 }
        ...
        L_0x0050:
            ...
            monitor-enter(r2)
            com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r4 = r7.workerRunningState     // Catch:{ all -> 0x0073 }
            com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r5 = com.google.firebase.concurrent.SequentialExecutor.WorkerRunningState.IDLE     // Catch:{ all -> 0x0073 }
            if (r4 == r5) goto L_0x0060
            com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r4 = r7.workerRunningState     // Catch:{ all -> 0x0073 }
            com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r5 = com.google.firebase.concurrent.SequentialExecutor.WorkerRunningState.QUEUING     // Catch:{ all -> 0x0073 }
            if (r4 != r5) goto L_0x0069
        L_0x0060:
            java.util.Deque<java.lang.Runnable> r7 = r7.queue     // Catch:{ all -> 0x0073 }
        ...
        L_0x0073:
            ...
            throw r7
        L_0x0076:
            java.util.Deque<java.lang.Runnable> r7 = r7.queue     // Catch:{ all -> 0x007d }
    ...
    private final class QueueWorker implements Runnable {
        ...
        private void workOnQueue() {
            ...
            L_0x002d:
                ...
                com.google.firebase.concurrent.SequentialExecutor r8 = com.google.firebase.concurrent.SequentialExecutor.this     // Catch:{ all -> 0x0083 }
                com.google.firebase.concurrent.SequentialExecutor$WorkerRunningState r0 = com.google.firebase.concurrent.SequentialExecutor.WorkerRunningState.IDLE     // Catch:{ all -> 0x0083 }
                com.google.firebase.concurrent.SequentialExecutor.WorkerRunningState unused = r8.workerRunningState = r0     // Catch:{ all -> 0x0083 }
                monitor-exit(r2)     // Catch:{ all -> 0x0083 }
