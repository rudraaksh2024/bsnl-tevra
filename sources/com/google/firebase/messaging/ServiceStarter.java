    ...
    private synchronized String resolveServiceClassName(Context context, Intent intent) {
        ...
        if (resolveService != null) {
            if (resolveService.serviceInfo != null) {
                ...
                Log.e(Constants.TAG, "Error resolving target intent service, skipping classname enforcement. Resolved service was: " + serviceInfo.packageName + PackagingURIHelper.FORWARD_SLASH_STRING + serviceInfo.name);
                return null;
            }
        }
