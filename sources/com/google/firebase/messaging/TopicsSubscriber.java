...
class TopicsSubscriber {
    ...
    private void markCompletePendingOperation(com.google.firebase.messaging.TopicOperation r5) {
        ...
        L_0x0025:
            ...
            java.util.Map<java.lang.String, java.util.ArrayDeque<com.google.android.gms.tasks.TaskCompletionSource<java.lang.Void>>> r4 = r4.pendingOperations     // Catch:{ all -> 0x0032 }
            r4.remove(r5)     // Catch:{ all -> 0x0032 }
        L_0x0030:
            monitor-exit(r0)     // Catch:{ all -> 0x0032 }
            return
        L_0x0032:
    ...
    public boolean performTopicOperation(com.google.firebase.messaging.TopicOperation r10) throws java.io.IOException {
        ...
        L_0x0030:
            ...
            boolean r9 = isDebugLogEnabled()     // Catch:{ IOException -> 0x009f }
            if (r9 == 0) goto L_0x009e
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x009f }
            r9.<init>(r3)     // Catch:{ IOException -> 0x009f }
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ IOException -> 0x009f }
            java.lang.String r10 = "."
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ IOException -> 0x009f }
            java.lang.String r9 = r9.toString()     // Catch:{ IOException -> 0x009f }
            android.util.Log.d(r0, r9)     // Catch:{ IOException -> 0x009f }
            goto L_0x009e
        L_0x0053:
            ...
            if (r9 == 0) goto L_0x009e
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x009f }
            r9.<init>(r1)     // Catch:{ IOException -> 0x009f }
            java.lang.String r10 = r10.getTopic()     // Catch:{ IOException -> 0x009f }
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ IOException -> 0x009f }
            java.lang.StringBuilder r9 = r9.append(r6)     // Catch:{ IOException -> 0x009f }
            java.lang.String r9 = r9.toString()     // Catch:{ IOException -> 0x009f }
            android.util.Log.d(r0, r9)     // Catch:{ IOException -> 0x009f }
            goto L_0x009e
        L_0x0079:
            ...
            if (r9 == 0) goto L_0x009e
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x009f }
            r9.<init>(r2)     // Catch:{ IOException -> 0x009f }
            java.lang.String r10 = r10.getTopic()     // Catch:{ IOException -> 0x009f }
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ IOException -> 0x009f }
            java.lang.StringBuilder r9 = r9.append(r6)     // Catch:{ IOException -> 0x009f }
            java.lang.String r9 = r9.toString()     // Catch:{ IOException -> 0x009f }
