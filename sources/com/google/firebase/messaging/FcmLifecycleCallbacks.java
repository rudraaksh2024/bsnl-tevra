...
class FcmLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        if (intent != null && this.seenIntents.add(intent)) {
            m304lambda$onActivityCreated$0$comgooglefirebasemessagingFcmLifecycleCallbacks(intent);
        }
    }
    ...
    public void m304lambda$onActivityCreated$0$comgooglefirebasemessagingFcmLifecycleCallbacks(Intent intent) {
        Bundle bundle = null;
        try {
