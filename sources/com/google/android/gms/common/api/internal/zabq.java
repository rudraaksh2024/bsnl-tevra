...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final boolean zaM(zai zai2) {
        ...
        if (indexOf >= 0) {
            ...
            GoogleApiManager googleApiManager = this.zaa;
            googleApiManager.zar.sendMessageDelayed(Message.obtain(googleApiManager.zar, 15, zabs2), DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
            return false;
        }
        this.zak.add(zabs);
        GoogleApiManager googleApiManager2 = this.zaa;
        googleApiManager2.zar.sendMessageDelayed(Message.obtain(googleApiManager2.zar, 15, zabs), DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
    ...
    private final boolean zaN(com.google.android.gms.common.ConnectionResult r4) {
        /*
            ...
            int r3 = r3.zah     // Catch:{ all -> 0x002a }
            r1.zah(r4, r3)     // Catch:{ all -> 0x002a }
