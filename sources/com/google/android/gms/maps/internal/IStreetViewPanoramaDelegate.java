...
public interface IStreetViewPanoramaDelegate extends IInterface {
    ...
    void setOnStreetViewPanoramaCameraChangeListener(@Nullable zzbk zzbk) throws RemoteException;

    void setOnStreetViewPanoramaChangeListener(@Nullable zzbm zzbm) throws RemoteException;

    void setOnStreetViewPanoramaClickListener(@Nullable zzbo zzbo) throws RemoteException;

    void setOnStreetViewPanoramaLongClickListener(@Nullable zzbq zzbq) throws RemoteException;
