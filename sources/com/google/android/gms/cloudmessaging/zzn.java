...
final class zzn implements ServiceConnection {
    int zza = 0;
    final Messenger zzb = new Messenger(new zzf(Looper.getMainLooper(), new zzk(this)));
    zzp zzc;
    final Queue zzd = new ArrayDeque();
    final SparseArray zze = new SparseArray();
    final /* synthetic */ zzu zzf;

    /* synthetic */ zzn(zzu zzu, zzm zzm) {
        this.zzf = zzu;
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        this.zzf.zzc.execute(new zzg(this, iBinder));
    }
    ...
    public final synchronized void zzb(int i, String str, Throwable th) {
        ...
        if (i2 == 0) {
            ...
            zzs zzs = new zzs(i, str, th);
            for (zzr zzc2 : this.zzd) {
                zzc2.zzc(zzs);
            }
            this.zzd.clear();
            for (int i3 = 0; i3 < this.zze.size(); i3++) {
                ((zzr) this.zze.valueAt(i3)).zzc(zzs);
            }
            this.zze.clear();
        } else if (i2 == 3) {
            this.zza = 4;
    ...
    public final synchronized void zze(int i) {
        zzr zzr = (zzr) this.zze.get(i);
        if (zzr != null) {
            Log.w("MessengerIpcClient", "Timing out request: " + i);
            this.zze.remove(i);
            zzr.zzc(new zzs(3, "Timed out waiting for response", (Throwable) null));
            zzf();
        }
    }
    ...
    public final synchronized void zzf() {
        ...
        L_0x0025:
            ...
            com.google.android.gms.cloudmessaging.zzu r0 = r2.zzf     // Catch:{ all -> 0x0039 }
        ...
        L_0x0039:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.cloudmessaging.zzn.zzf():void");
    }

    /* access modifiers changed from: package-private */
    public final synchronized boolean zzg(zzr zzr) {
        int i = this.zza;
        if (i == 0) {
            this.zzd.add(zzr);
