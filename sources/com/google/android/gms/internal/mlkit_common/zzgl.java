...
final class zzgl implements ObjectEncoder {
    ...
    static {
        ...
        zzbk zzbk103 = new zzbk();
        zzbk103.zza(106);
        zzaZ = builder103.withProperty(zzbk103.zzb()).build();
        FieldDescriptor.Builder builder104 = FieldDescriptor.builder("lowLightAutoExposureComputationEvent");
        zzbk zzbk104 = new zzbk();
        zzbk104.zza(107);
        zzba = builder104.withProperty(zzbk104.zzb()).build();
        FieldDescriptor.Builder builder105 = FieldDescriptor.builder("lowLightFrameProcessEvent");
        zzbk zzbk105 = new zzbk();
        zzbk105.zza(108);
        zzbb = builder105.withProperty(zzbk105.zzb()).build();
        FieldDescriptor.Builder builder106 = FieldDescriptor.builder("lowLightSceneDetectionEvent");
        zzbk zzbk106 = new zzbk();
        zzbk106.zza(109);
        zzbc = builder106.withProperty(zzbk106.zzb()).build();
    }
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, Object obj2) throws IOException {
        ...
        objectEncoderContext.add(zzb, (Object) zzlq.zzf());
        objectEncoderContext.add(zzc, (Object) zzlq.zzd());
        objectEncoderContext.add(zzd, (Object) null);
        objectEncoderContext.add(zze, (Object) null);
        objectEncoderContext.add(zzf, (Object) zzlq.zze());
        ...
        objectEncoderContext.add(zzL, (Object) null);
        objectEncoderContext.add(zzM, (Object) null);
        objectEncoderContext.add(zzN, (Object) zzlq.zzb());
        objectEncoderContext.add(zzO, (Object) zzlq.zza());
        objectEncoderContext.add(zzP, (Object) null);
        objectEncoderContext.add(zzQ, (Object) null);
        objectEncoderContext.add(zzR, (Object) null);
        objectEncoderContext.add(zzS, (Object) null);
        ...
        objectEncoderContext.add(zzab, (Object) zzlq.zzc());
