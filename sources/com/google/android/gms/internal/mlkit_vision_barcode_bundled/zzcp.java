...
final class zzcp {
    ...
    static int zzb(byte[] bArr, int i) {
        ...
        return ((bArr[i + 3] & UByte.MAX_VALUE) << 24) | (b2 << 8) | b | (b3 << UnionPtg.sid);
    }
            ...
            if ((zzj | i4 | ((length - zzj) - i4)) >= 0) {
                ...
                while (i2 < i6) {
                    ...
                    if (zzhj.zzd(b2)) {
                        ...
                        if (i8 < i6 - 1) {
                            int i10 = i8 + 1;
                            zzhj.zzb(b2, bArr[i8], bArr[i10], cArr, i3);
                            i2 = i10 + 1;
                            i3++;
                        } else {
                            throw zzeo.zzc();
                        ...
                        byte b4 = bArr[i8];
                        int i12 = i11 + 1;
                        zzhj.zza(b2, b4, bArr[i11], bArr[i12], cArr, i3);
                        i3 += 2;
                        i2 = i12 + 1;
                    } else {
                        throw zzeo.zzc();
    ...
    static int zzk(int i, byte[] bArr, int i2, zzco zzco) {
        ...
        byte b2 = bArr[i3];
        if (b2 >= 0) {
            zzco.zza = i5 | (b2 << NotEqualPtg.sid);
            return i6;
        }
        int i7 = i5 | ((b2 & ByteCompanionObject.MAX_VALUE) << NotEqualPtg.sid);
        int i8 = i6 + 1;
        byte b3 = bArr[i6];
        if (b3 >= 0) {
            zzco.zza = i7 | (b3 << ParenthesisPtg.sid);
            return i8;
        }
        int i9 = i7 | ((b3 & ByteCompanionObject.MAX_VALUE) << ParenthesisPtg.sid);
        int i10 = i8 + 1;
        byte b4 = bArr[i8];
        if (b4 >= 0) {
            zzco.zza = i9 | (b4 << 28);
