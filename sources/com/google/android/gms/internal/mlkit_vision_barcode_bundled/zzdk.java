...
final class zzdk implements zzhq {
    ...
    private zzdk(zzdj zzdj) {
        byte[] bArr = zzem.zzd;
        this.zza = zzdj;
        zzdj.zza = this;
    }

    public static zzdk zza(zzdj zzdj) {
        zzdk zzdk = zzdj.zza;
        return zzdk != null ? zzdk : new zzdk(zzdj);
    }

    public final void zzB(int i, int i2) throws IOException {
        zzdj zzdj = this.zza;
        zzdj.zzp(i, (i2 >> 31) ^ (i2 + i2));
    }
    ...
    public final void zzq(int i, Object obj, zzgh zzgh) throws IOException {
        zzdj zzdj = this.zza;
        zzdj.zzo(i, 3);
        zzgh.zzi((zzfo) obj, zzdj.zza);
        zzdj.zzo(i, 4);
    }
    ...
    public final void zzv(int i, Object obj, zzgh zzgh) throws IOException {
        zzfo zzfo = (zzfo) obj;
        zzdg zzdg = (zzdg) this.zza;
        zzdg.zzq((i << 3) | 2);
        zzdg.zzq(((zzck) zzfo).zzB(zzgh));
        zzgh.zzi(zzfo, zzdg.zza);
    }
    ...
    public final void zzC(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i2 < list.size()) {
                ...
                zzdj.zzq((intValue2 >> 31) ^ (intValue2 + intValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzdj2.zzp(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzE(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i2 < list.size()) {
                ...
                zzdj.zzs((longValue2 >> 63) ^ (longValue2 + longValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzdj2.zzr(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
