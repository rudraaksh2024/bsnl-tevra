...
final class zzfi implements ObjectEncoderContext {
    ...
    private static final ObjectEncoder zzd = zzfh.zza;
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzfg zzfg = (zzfg) fieldDescriptor.getProperty(zzfg.class);
        if (zzfg != null) {
            return zzfg.zza();
        }
    ...
    /* access modifiers changed from: package-private */
    public final zzfi zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzfg zzj = zzj(fieldDescriptor);
        zzff zzff = zzff.DEFAULT;
    ...
    /* access modifiers changed from: package-private */
    public final zzfi zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzfg zzj = zzj(fieldDescriptor);
    ...
    /* access modifiers changed from: package-private */
    public final zzfi zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
