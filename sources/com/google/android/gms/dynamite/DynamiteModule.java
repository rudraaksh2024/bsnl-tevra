...
public final class DynamiteModule {
    ...
    public static int zza(android.content.Context r10, java.lang.String r11, boolean r12) {
        ...
        L_0x00a0:
            ...
            r5.append(r1)     // Catch:{ all -> 0x01a6 }
            java.lang.String r1 = r5.toString()     // Catch:{ all -> 0x01a6 }
            android.util.Log.w(r4, r1)     // Catch:{ all -> 0x01a6 }
        ...
        L_0x00cb:
            ...
            r0.append(r11)     // Catch:{ all -> 0x01a9 }
            java.lang.String r11 = r0.toString()     // Catch:{ all -> 0x01a9 }
            android.util.Log.w(r12, r11)     // Catch:{ all -> 0x01a9 }
            return r3
        L_0x00e7:
        ...
        L_0x017e:
            ...
            java.lang.String r12 = r12.getMessage()     // Catch:{ all -> 0x019e }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x019e }
            r0.<init>()     // Catch:{ all -> 0x019e }
            java.lang.String r1 = "Failed to retrieve remote module version: "
            r0.append(r1)     // Catch:{ all -> 0x019e }
            r0.append(r12)     // Catch:{ all -> 0x019e }
            java.lang.String r12 = r0.toString()     // Catch:{ all -> 0x019e }
