...
public class Base64 {
    ...
    public final byte[] encodeToByteArray(byte[] bArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(bArr, Constants.ScionAnalytics.PARAM_SOURCE);
    ...
    public final byte[] decode(CharSequence charSequence, int i, int i2) {
        byte[] bArr;
        Intrinsics.checkNotNullParameter(charSequence, Constants.ScionAnalytics.PARAM_SOURCE);
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        while (true) {
            ...
            while (i6 < min) {
                int i7 = i2 + 1;
                int i8 = i7 + 1;
                byte b = ((bArr[i2] & UByte.MAX_VALUE) << UnionPtg.sid) | ((bArr[i7] & UByte.MAX_VALUE) << 8) | (bArr[i8] & UByte.MAX_VALUE);
                int i9 = i5 + 1;
                bArr2[i5] = access$getBase64UrlEncodeMap$p[b >>> UnaryPlusPtg.sid];
                int i10 = i9 + 1;
                bArr2[i9] = access$getBase64UrlEncodeMap$p[(b >>> 12) & 63];
                int i11 = i10 + 1;
                bArr2[i10] = access$getBase64UrlEncodeMap$p[(b >>> 6) & 63];
                i5 = i11 + 1;
                bArr2[i11] = access$getBase64UrlEncodeMap$p[b & 63];
                i6++;
                i2 = i8 + 1;
            }
            if (min == i4 && i2 != i3) {
        ...
        if (i13 == 1) {
            int i14 = i2 + 1;
            int i15 = (bArr[i2] & UByte.MAX_VALUE) << 4;
            int i16 = i5 + 1;
            ...
            int i19 = i2 + 1;
            int i20 = i19 + 1;
            int i21 = ((bArr[i19] & UByte.MAX_VALUE) << 2) | ((bArr[i2] & UByte.MAX_VALUE) << 10);
            int i22 = i5 + 1;
    ...
    private final int decodeImpl(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        while (true) {
            ...
            if (i7 == i5 && i9 + 3 < i4) {
                int i10 = i9 + 1;
                int i11 = access$getBase64UrlDecodeMap$p[bArr3[i9] & UByte.MAX_VALUE];
                int i12 = i10 + 1;
                int i13 = access$getBase64UrlDecodeMap$p[bArr3[i10] & UByte.MAX_VALUE];
                int i14 = i12 + 1;
                int i15 = access$getBase64UrlDecodeMap$p[bArr3[i12] & UByte.MAX_VALUE];
                int i16 = i14 + 1;
                int i17 = (i15 << 6) | (i11 << 18) | (i13 << 12) | access$getBase64UrlDecodeMap$p[bArr3[i14] & UByte.MAX_VALUE];
                if (i17 >= 0) {
                    int i18 = i6 + 1;
