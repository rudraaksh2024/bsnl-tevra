...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getInvariantSeparatorsPathString(Path path) {
        ...
        if (Intrinsics.areEqual((Object) separator, (Object) PackagingURIHelper.FORWARD_SLASH_STRING)) {
            return path.toString();
        }
        String obj = path.toString();
        Intrinsics.checkNotNullExpressionValue(separator, "separator");
        return StringsKt.replace$default(obj, separator, PackagingURIHelper.FORWARD_SLASH_STRING, false, 4, (Object) null);
    }
