...
public final class UStringsKt {
    ...
    public static final String m1632toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1634toStringolVBNx4(short s, int i) {
    ...
    public static final String m1633toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1631toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m396unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m659unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m475unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m554unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m475unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m423constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m340boximpl(UByte.m346constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m475unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m423constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m603boximpl(UShort.m609constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m423constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m423constructorimpl(i3 * r3);
            int r7 = UInt.m423constructorimpl(UInt.m423constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m502constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m502constructorimpl(j * r5);
            long r13 = ULong.m502constructorimpl(ULong.m502constructorimpl(((long) UInt.m423constructorimpl(digitOf)) & 4294967295L) + r9);
