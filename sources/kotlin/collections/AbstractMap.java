...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(entrySet(), ", ", VectorFormat.DEFAULT_PREFIX, VectorFormat.DEFAULT_SUFFIX, 0, (CharSequence) null, new AbstractMap$toString$1(this), 24, (Object) null);
    }

    /* access modifiers changed from: private */
    public final String toString(Map.Entry<? extends K, ? extends V> entry) {
        return toString((Object) entry.getKey()) + Chars.EQ + toString((Object) entry.getValue());
    }
    ...
    public static final class Companion {
        ...
        public final String entryToString$kotlin_stdlib(Map.Entry<?, ?> entry) {
            Intrinsics.checkNotNullParameter(entry, "e");
            return new StringBuilder().append(entry.getKey()).append(Chars.EQ).append(entry.getValue()).toString();
        }
