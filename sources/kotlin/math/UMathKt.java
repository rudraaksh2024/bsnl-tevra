...
public final class UMathKt {
    ...
    private static final int m1536minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1518minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1537mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1526minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1534maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1506maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1535maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1514maxOfeb3DHEI(j, j2);
    }
}
