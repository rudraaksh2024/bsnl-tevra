...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public long m1793markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1805constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1792elapsedFrom6eNON_k(long j) {
    ...
    public final long m1791differenceBetweenfRLX17w(long j, long j2) {
        return LongSaturatedMathKt.saturatingOriginsDiff(j, j2, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m1790adjustReading6QKq23U(long j, long j2) {
        return TimeSource.Monotonic.ValueTimeMark.m1805constructorimpl(LongSaturatedMathKt.m1788saturatingAddNuflL3o(j, DurationUnit.NANOSECONDS, j2));
    }
}
