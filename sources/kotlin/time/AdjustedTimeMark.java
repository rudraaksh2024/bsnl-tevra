...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1648getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1649minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1799minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1647elapsedNowUwyO8pc() {
        return Duration.m1694minusLRDsOJo(this.mark.m1796elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1650plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1695plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
