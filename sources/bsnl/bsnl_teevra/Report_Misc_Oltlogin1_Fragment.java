...
public class Report_Misc_Oltlogin1_Fragment extends Fragment {
    private PieChart piechart;
    private TextView txt_header;

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.report_misc_oltlogin1_fragment, viewGroup, false);
        ...
        try {
            ...
            arrayList.add(new PieEntry(Float.parseFloat(string4), "UPDATED"));
            arrayList.add(new PieEntry(Float.parseFloat(string5), "NOT UPDATED"));
            ...
            PieDataSet pieDataSet = new PieDataSet(arrayList, "OLT LOGIN CREDENTIALS");
            pieDataSet.setValueFormatter(new ValueFormatter() {
                public String getFormattedValue(float f) {
                    return Float.toString(Float.parseFloat(new DecimalFormat("###").format((double) Float.parseFloat(String.valueOf(f)))));
                }
            });
            ...
            this.piechart.setCenterText("TIP OLT LOGIN CREDENTIAL INDEX\n\n" + decimalFormat.format((double) parseFloat) + "%");
