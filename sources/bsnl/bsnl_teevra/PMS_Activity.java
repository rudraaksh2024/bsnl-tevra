...
public class PMS_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.pms_activity);
        DisplayMetrics displayMetrics = new DisplayMetrics();
        getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);
        int i = displayMetrics.widthPixels;
        SharedPreferences sharedPreferences2 = getSharedPreferences("myloginpreference", 0);
        this.sharedPreferences = sharedPreferences2;
        this.Pref_designation = sharedPreferences2.getString("designation_Key", (String) null);
        ...
        if (this.Pref_designation.equals("FRANCHISEE OWNER") || this.Pref_designation.equals("FRANCHISEE MEMBER")) {
            ...
            this.Pref_Fms_Username = "";
        }
        RequestQueue newRequestQueue = Volley.newRequestQueue(this);
        AnonymousClass3 r5 = new StringRequest(1, getString(R.string.serverip) + "pms_count.php", new Response.Listener<String>() {
            public void onResponse(String str) {
                PMS_Activity.this.progress_dialog.cancel();
                try {
                    ...
                    if (jSONObject.getInt("ONLINE") > 0) {
                        PMS_Activity.this.txt_pms_enabled.setTextColor(PMS_Activity.this.getResources().getColor(R.color.colorGreen));
                    } else {
                        PMS_Activity.this.txt_pms_enabled.setTextColor(PMS_Activity.this.getResources().getColor(R.color.colorRed));
                    }
                    if (jSONObject.getInt("OFFLINE") > 0) {
                        PMS_Activity.this.txt_pms_disabled.setTextColor(PMS_Activity.this.getResources().getColor(R.color.colorRed));
                    } else {
                        PMS_Activity.this.txt_pms_disabled.setTextColor(PMS_Activity.this.getResources().getColor(R.color.colorGreen));
                    }
                    PMS_Activity.this.txt_pms_enabled.setText(string);
                    PMS_Activity.this.txt_pms_disabled.setText(string2);
                    PMS_Activity.this.txt_pms_total.setText(string3);
            ...
            public void onErrorResponse(VolleyError volleyError) {
                PMS_Activity.this.progress_dialog.cancel();
                PMS_Activity.this.txt_alert.setText(new VolleyErrorHelper().onErrorResponse(volleyError, PMS_Activity.this.getApplicationContext()));
                PMS_Activity.this.error_dialog.show();
            }
        }) {
            /* access modifiers changed from: protected */
            public Map<String, String> getParams() throws AuthFailureError {
                HashMap hashMap = new HashMap();
                hashMap.put("circle", PMS_Activity.this.Pref_Circle);
                hashMap.put("ssa", PMS_Activity.this.Pref_SSA);
                hashMap.put("fms_username", PMS_Activity.this.Pref_Fms_Username);
                hashMap.put("username", PMS_Activity.this.Pref_Username);
                hashMap.put("random_key", PMS_Activity.this.Pref_Randkey);
                hashMap.put("device_id", PMS_Activity.this.androidId);
                return hashMap;
            }
        };
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.img_header) {
            ...
            startActivity(new Intent(this, PMS_Tip_Activity.class));
        }
    }
}
