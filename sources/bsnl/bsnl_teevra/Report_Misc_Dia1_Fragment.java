...
public class Report_Misc_Dia1_Fragment extends Fragment {
    private PieChart piechart;
    private TextView txt_header;

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.report_misc_dia1_fragment, viewGroup, false);
        ...
        try {
            ...
            arrayList.add(new PieEntry(Float.parseFloat(string4), "Active"));
            arrayList.add(new PieEntry(Float.parseFloat(string5), "Inactive"));
            ...
            PieDataSet pieDataSet = new PieDataSet(arrayList, "Teevra Users");
