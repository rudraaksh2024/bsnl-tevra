...
public class Fms_Provison_MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout lay_provison;
    private LinearLayout lay_provison_track;
    /* access modifiers changed from: private */
    public AlertDialog logout_dialog;
    private AlertDialog progress_dialog;
    /* access modifiers changed from: private */
    public SharedPreferences sharedPreferences;
    private Spannable span_pro;
    private TextView txt_alert;
    private TextView txt_provision_pending;

    /* access modifiers changed from: protected */
    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.fms_provison_mainactivity);
        ...
        this.txt_provision_pending = (TextView) findViewById(R.id.txt_provision_pending);
        try {
            this.txt_provision_pending.setText(new JSONObject(getIntent().getStringExtra("RESPONSE")).getJSONObject("PENDING_PROVISION").getString("COUNT"));
        } catch (JSONException e) {
            e.printStackTrace();
        }
        SpannableString spannableString = new SpannableString(this.txt_provision_pending.getText());
        this.span_pro = spannableString;
        spannableString.setSpan(new RelativeSizeSpan(3.0f), 0, this.txt_provision_pending.length(), 33);
        this.txt_provision_pending.setText(this.span_pro);
        LinearLayout linearLayout2 = (LinearLayout) findViewById(R.id.lay_provison);
        this.lay_provison = linearLayout2;
        ...
        if (itemId == R.id.teevrahome) {
            ...
            ((TextView) inflate.findViewById(R.id.txt_cancel)).setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    Fms_Provison_MainActivity.this.logout_dialog.cancel();
                }
            });
            ((TextView) inflate.findViewById(R.id.txt_submit)).setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    Fms_Provison_MainActivity fms_Provison_MainActivity = Fms_Provison_MainActivity.this;
                    fms_Provison_MainActivity.editor = fms_Provison_MainActivity.sharedPreferences.edit();
                    Fms_Provison_MainActivity.this.editor.remove("isfmsloggedin_key");
                    Fms_Provison_MainActivity.this.editor.commit();
                    Intent intent = new Intent(Fms_Provison_MainActivity.this, FMS_Login_Activity.class);
                    intent.setFlags(67108864);
                    Fms_Provison_MainActivity.this.startActivity(intent);
                    Fms_Provison_MainActivity.this.finish();
                    Fms_Provison_MainActivity.this.logout_dialog.cancel();
                }
            });
        }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.lay_provison) {
            startActivity(new Intent(this, FMS_Provision_Activity.class));
        }
    }
}
