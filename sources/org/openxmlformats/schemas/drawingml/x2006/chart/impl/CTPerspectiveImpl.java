...
public class CTPerspectiveImpl extends XmlComplexContentImpl implements CTPerspective {
    ...
    public short getVal() {
        ...
        L_0x0022:
            ...
            goto L_0x0029
        L_0x0025:
            short r3 = r1.getShortValue()     // Catch:{ all -> 0x002b }
        L_0x0029:
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTPerspectiveImpl.getVal():short");
    }

    public STPerspective xgetVal() {
        STPerspective find_attribute_user;
        synchronized (monitor()) {
            ...
            if (find_attribute_user == null) {
                find_attribute_user = get_default_attribute_value(qNameArr[0]);
            }
        }
    ...
    public void setVal(short r6) {
        /*
            ...
            org.apache.xmlbeans.SimpleValue r1 = (org.apache.xmlbeans.SimpleValue) r1     // Catch:{ all -> 0x002b }
        L_0x0026:
            r1.setShortValue(r6)     // Catch:{ all -> 0x002b }
            monitor-exit(r0)     // Catch:{ all -> 0x002b }
            return
        L_0x002b:
            r5 = move-exception
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTPerspectiveImpl.setVal(short):void");
    }
    ...
    public void xsetVal(STPerspective sTPerspective) {
        synchronized (monitor()) {
            ...
            TypeStore typeStore = get_store();
            QName[] qNameArr = PROPERTY_QNAME;
            STPerspective find_attribute_user = typeStore.find_attribute_user(qNameArr[0]);
            if (find_attribute_user == null) {
                find_attribute_user = get_store().add_attribute_user(qNameArr[0]);
            }
            find_attribute_user.set(sTPerspective);
        }
    }
