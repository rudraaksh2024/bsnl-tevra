...
public class CTCatAxImpl extends XmlComplexContentImpl implements CTCatAx {
    ...
    public void setLblAlgn(CTLblAlgn cTLblAlgn) {
        generatedSetterHelperImpl(cTLblAlgn, PROPERTY_QNAME[17], 0, 1);
    }
    ...
    public void setLblOffset(CTLblOffset cTLblOffset) {
        generatedSetterHelperImpl(cTLblOffset, PROPERTY_QNAME[18], 0, 1);
    }
    ...
    public void setTickLblSkip(CTSkip cTSkip) {
        generatedSetterHelperImpl(cTSkip, PROPERTY_QNAME[19], 0, 1);
    }
    ...
    public void setTickMarkSkip(CTSkip cTSkip) {
        generatedSetterHelperImpl(cTSkip, PROPERTY_QNAME[20], 0, 1);
    }
    ...
    public void setNoMultiLvlLbl(CTBoolean cTBoolean) {
        generatedSetterHelperImpl(cTBoolean, PROPERTY_QNAME[21], 0, 1);
    }
    ...
    public void setExtLst(CTExtensionList cTExtensionList) {
        generatedSetterHelperImpl(cTExtensionList, PROPERTY_QNAME[22], 0, 1);
    }
