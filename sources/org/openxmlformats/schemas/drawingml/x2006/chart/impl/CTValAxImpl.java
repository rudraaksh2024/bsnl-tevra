...
public class CTValAxImpl extends XmlComplexContentImpl implements CTValAx {
    ...
    public void setCrossBetween(CTCrossBetween cTCrossBetween) {
        generatedSetterHelperImpl(cTCrossBetween, PROPERTY_QNAME[16], 0, 1);
    }
    ...
    public void setMajorUnit(CTAxisUnit cTAxisUnit) {
        generatedSetterHelperImpl(cTAxisUnit, PROPERTY_QNAME[17], 0, 1);
    }
    ...
    public void setMinorUnit(CTAxisUnit cTAxisUnit) {
        generatedSetterHelperImpl(cTAxisUnit, PROPERTY_QNAME[18], 0, 1);
    }
    ...
    public void setDispUnits(CTDispUnits cTDispUnits) {
        generatedSetterHelperImpl(cTDispUnits, PROPERTY_QNAME[19], 0, 1);
    }
    ...
    public void setExtLst(CTExtensionList cTExtensionList) {
        generatedSetterHelperImpl(cTExtensionList, PROPERTY_QNAME[20], 0, 1);
    }
