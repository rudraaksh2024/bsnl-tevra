...
public class CTMarkerSizeImpl extends XmlComplexContentImpl implements CTMarkerSize {
    ...
    public short getVal() {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTMarkerSizeImpl.getVal():short");
    }

    public STMarkerSize xgetVal() {
        STMarkerSize find_attribute_user;
    ...
    public void setVal(short r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTMarkerSizeImpl.setVal(short):void");
    }
    ...
    public void xsetVal(STMarkerSize sTMarkerSize) {
        synchronized (monitor()) {
            ...
            TypeStore typeStore = get_store();
            QName[] qNameArr = PROPERTY_QNAME;
            STMarkerSize find_attribute_user = typeStore.find_attribute_user(qNameArr[0]);
            if (find_attribute_user == null) {
                find_attribute_user = get_store().add_attribute_user(qNameArr[0]);
            }
            find_attribute_user.set(sTMarkerSize);
        }
    }
