...
public class CTSurfaceChartImpl extends XmlComplexContentImpl implements CTSurfaceChart {
    ...
    public List<CTSurfaceSer> getSerList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTSurfaceChartImpl$$ExternalSyntheticLambda0(this), new CTSurfaceChartImpl$$ExternalSyntheticLambda1(this), new CTSurfaceChartImpl$$ExternalSyntheticLambda2(this), new CTSurfaceChartImpl$$ExternalSyntheticLambda3(this), new CTSurfaceChartImpl$$ExternalSyntheticLambda4(this));
        }
    ...
    public List<CTUnsignedInt> getAxIdList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTSurfaceChartImpl$$ExternalSyntheticLambda5(this), new CTSurfaceChartImpl$$ExternalSyntheticLambda6(this), new CTSurfaceChartImpl$$ExternalSyntheticLambda7(this), new CTSurfaceChartImpl$$ExternalSyntheticLambda8(this), new CTSurfaceChartImpl$$ExternalSyntheticLambda9(this));
        }
        return javaListXmlObject;
    }
