...
public class CTAreaChartImpl extends XmlComplexContentImpl implements CTAreaChart {
    ...
    public List<CTAreaSer> getSerList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTAreaChartImpl$$ExternalSyntheticLambda0(this), new CTAreaChartImpl$$ExternalSyntheticLambda1(this), new CTAreaChartImpl$$ExternalSyntheticLambda2(this), new CTAreaChartImpl$$ExternalSyntheticLambda3(this), new CTAreaChartImpl$$ExternalSyntheticLambda4(this));
        }
    ...
    public List<CTUnsignedInt> getAxIdList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTAreaChartImpl$$ExternalSyntheticLambda5(this), new CTAreaChartImpl$$ExternalSyntheticLambda6(this), new CTAreaChartImpl$$ExternalSyntheticLambda7(this), new CTAreaChartImpl$$ExternalSyntheticLambda8(this), new CTAreaChartImpl$$ExternalSyntheticLambda9(this));
        }
        return javaListXmlObject;
    }

    public CTUnsignedInt[] getAxIdArray() {
        return (CTUnsignedInt[]) getXmlObjectArray(PROPERTY_QNAME[5], (T[]) new CTUnsignedInt[0]);
    }
    ...
    public CTUnsignedInt getAxIdArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTUnsignedInt = (CTUnsignedInt) get_store().find_element_user(PROPERTY_QNAME[5], i);
    ...
    public void setAxIdArray(CTUnsignedInt[] cTUnsignedIntArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTUnsignedIntArr, PROPERTY_QNAME[5]);
    }

    public void setAxIdArray(int i, CTUnsignedInt cTUnsignedInt) {
        generatedSetterHelperImpl(cTUnsignedInt, PROPERTY_QNAME[5], i, 2);
    }
    ...
    public CTUnsignedInt insertNewAxId(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTUnsignedInt = (CTUnsignedInt) get_store().insert_element_user(PROPERTY_QNAME[5], i);
        }
        return cTUnsignedInt;
    }
