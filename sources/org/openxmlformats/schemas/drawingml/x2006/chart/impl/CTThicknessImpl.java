...
public class CTThicknessImpl extends XmlComplexContentImpl implements CTThickness {
    ...
    public STThickness xgetVal() {
        STThickness find_attribute_user;
        synchronized (monitor()) {
            check_orphaned();
    ...
    public void setVal(java.lang.Object r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTThicknessImpl.setVal(java.lang.Object):void");
    }
    ...
    public void xsetVal(STThickness sTThickness) {
        synchronized (monitor()) {
            ...
            STThickness find_attribute_user = typeStore.find_attribute_user(qNameArr[0]);
            if (find_attribute_user == null) {
                find_attribute_user = get_store().add_attribute_user(qNameArr[0]);
            }
            find_attribute_user.set(sTThickness);
        }
    }
}
