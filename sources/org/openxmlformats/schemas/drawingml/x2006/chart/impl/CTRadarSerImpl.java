...
public class CTRadarSerImpl extends XmlComplexContentImpl implements CTRadarSer {
    ...
    public List<CTDPt> getDPtList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTRadarSerImpl$$ExternalSyntheticLambda0(this), new CTRadarSerImpl$$ExternalSyntheticLambda1(this), new CTRadarSerImpl$$ExternalSyntheticLambda2(this), new CTRadarSerImpl$$ExternalSyntheticLambda3(this), new CTRadarSerImpl$$ExternalSyntheticLambda4(this));
        }
