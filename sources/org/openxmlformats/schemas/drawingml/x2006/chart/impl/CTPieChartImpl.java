...
public class CTPieChartImpl extends XmlComplexContentImpl implements CTPieChart {
    ...
    public List<CTPieSer> getSerList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTPieChartImpl$$ExternalSyntheticLambda0(this), new CTPieChartImpl$$ExternalSyntheticLambda1(this), new CTPieChartImpl$$ExternalSyntheticLambda2(this), new CTPieChartImpl$$ExternalSyntheticLambda3(this), new CTPieChartImpl$$ExternalSyntheticLambda4(this));
        }
