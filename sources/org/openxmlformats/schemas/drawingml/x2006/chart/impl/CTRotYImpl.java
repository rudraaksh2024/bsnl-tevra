...
public class CTRotYImpl extends XmlComplexContentImpl implements CTRotY {
    ...
    public int getVal() {
        ...
        L_0x0022:
            ...
            goto L_0x0029
        L_0x0025:
            int r3 = r1.getIntValue()     // Catch:{ all -> 0x002b }
        L_0x0029:
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTRotYImpl.getVal():int");
    }

    public STRotY xgetVal() {
        STRotY find_attribute_user;
    ...
    public void setVal(int r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTRotYImpl.setVal(int):void");
    }
    ...
    public void xsetVal(STRotY sTRotY) {
        synchronized (monitor()) {
            ...
            TypeStore typeStore = get_store();
            QName[] qNameArr = PROPERTY_QNAME;
            STRotY find_attribute_user = typeStore.find_attribute_user(qNameArr[0]);
            if (find_attribute_user == null) {
                find_attribute_user = get_store().add_attribute_user(qNameArr[0]);
            }
            find_attribute_user.set(sTRotY);
        }
    }
