...
public class CTAxisUnitImpl extends XmlComplexContentImpl implements CTAxisUnit {
    ...
    public STAxisUnit xgetVal() {
        STAxisUnit find_attribute_user;
        synchronized (monitor()) {
            check_orphaned();
    ...
    public void setVal(double r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTAxisUnitImpl.setVal(double):void");
    }
    ...
    public void xsetVal(STAxisUnit sTAxisUnit) {
        synchronized (monitor()) {
            ...
            STAxisUnit find_attribute_user = typeStore.find_attribute_user(qNameArr[0]);
            if (find_attribute_user == null) {
                find_attribute_user = get_store().add_attribute_user(qNameArr[0]);
            }
            find_attribute_user.set(sTAxisUnit);
        }
    }
}
