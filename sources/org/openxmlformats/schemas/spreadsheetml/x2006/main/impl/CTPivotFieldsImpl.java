...
public class CTPivotFieldsImpl extends XmlComplexContentImpl implements CTPivotFields {
    ...
    public List<CTPivotField> getPivotFieldList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTPivotFieldsImpl$$ExternalSyntheticLambda0(this), new CTPivotFieldsImpl$$ExternalSyntheticLambda1(this), new CTPivotFieldsImpl$$ExternalSyntheticLambda2(this), new CTPivotFieldsImpl$$ExternalSyntheticLambda3(this), new CTPivotFieldsImpl$$ExternalSyntheticLambda4(this));
        }
        return javaListXmlObject;
    }

    public CTPivotField[] getPivotFieldArray() {
        return (CTPivotField[]) getXmlObjectArray(PROPERTY_QNAME[0], (T[]) new CTPivotField[0]);
    }
    ...
    public CTPivotField getPivotFieldArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPivotField = (CTPivotField) get_store().find_element_user(PROPERTY_QNAME[0], i);
    ...
    public void setPivotFieldArray(CTPivotField[] cTPivotFieldArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTPivotFieldArr, PROPERTY_QNAME[0]);
    }

    public void setPivotFieldArray(int i, CTPivotField cTPivotField) {
        generatedSetterHelperImpl(cTPivotField, PROPERTY_QNAME[0], i, 2);
    }
    ...
    public CTPivotField insertNewPivotField(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPivotField = (CTPivotField) get_store().insert_element_user(PROPERTY_QNAME[0], i);
        }
        return cTPivotField;
    }
    ...
    public void setCount(long r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTPivotFieldsImpl.setCount(long):void");
    }
    ...
    public void xsetCount(org.apache.xmlbeans.XmlUnsignedInt r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTPivotFieldsImpl.xsetCount(org.apache.xmlbeans.XmlUnsignedInt):void");
    }
