...
public class CTBordersImpl extends XmlComplexContentImpl implements CTBorders {
    ...
    public List<CTBorder> getBorderList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTBordersImpl$$ExternalSyntheticLambda0(this), new CTBordersImpl$$ExternalSyntheticLambda1(this), new CTBordersImpl$$ExternalSyntheticLambda2(this), new CTBordersImpl$$ExternalSyntheticLambda3(this), new CTBordersImpl$$ExternalSyntheticLambda4(this));
        }
        return javaListXmlObject;
    }

    public CTBorder[] getBorderArray() {
        return (CTBorder[]) getXmlObjectArray(PROPERTY_QNAME[0], (T[]) new CTBorder[0]);
    }
    ...
    public CTBorder getBorderArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTBorder = (CTBorder) get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (cTBorder == null) {
    ...
    public void setBorderArray(CTBorder[] cTBorderArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTBorderArr, PROPERTY_QNAME[0]);
    }

    public void setBorderArray(int i, CTBorder cTBorder) {
        generatedSetterHelperImpl(cTBorder, PROPERTY_QNAME[0], i, 2);
    }
    ...
    public CTBorder insertNewBorder(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTBorder = (CTBorder) get_store().insert_element_user(PROPERTY_QNAME[0], i);
        }
        return cTBorder;
    }
    ...
    public void setCount(long r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTBordersImpl.setCount(long):void");
    }
    ...
    public void xsetCount(org.apache.xmlbeans.XmlUnsignedInt r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTBordersImpl.xsetCount(org.apache.xmlbeans.XmlUnsignedInt):void");
    }
