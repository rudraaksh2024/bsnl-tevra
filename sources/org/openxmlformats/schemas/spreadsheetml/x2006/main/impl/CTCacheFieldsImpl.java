...
public class CTCacheFieldsImpl extends XmlComplexContentImpl implements CTCacheFields {
    ...
    public List<CTCacheField> getCacheFieldList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTCacheFieldsImpl$$ExternalSyntheticLambda0(this), new CTCacheFieldsImpl$$ExternalSyntheticLambda1(this), new CTCacheFieldsImpl$$ExternalSyntheticLambda2(this), new CTCacheFieldsImpl$$ExternalSyntheticLambda3(this), new CTCacheFieldsImpl$$ExternalSyntheticLambda4(this));
        }
        return javaListXmlObject;
    }

    public CTCacheField[] getCacheFieldArray() {
        return (CTCacheField[]) getXmlObjectArray(PROPERTY_QNAME[0], (T[]) new CTCacheField[0]);
    }
    ...
    public CTCacheField getCacheFieldArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCacheField = (CTCacheField) get_store().find_element_user(PROPERTY_QNAME[0], i);
    ...
    public void setCacheFieldArray(CTCacheField[] cTCacheFieldArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTCacheFieldArr, PROPERTY_QNAME[0]);
    }

    public void setCacheFieldArray(int i, CTCacheField cTCacheField) {
        generatedSetterHelperImpl(cTCacheField, PROPERTY_QNAME[0], i, 2);
    }
    ...
    public CTCacheField insertNewCacheField(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCacheField = (CTCacheField) get_store().insert_element_user(PROPERTY_QNAME[0], i);
        }
        return cTCacheField;
    }
    ...
    public void setCount(long r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTCacheFieldsImpl.setCount(long):void");
    }
    ...
    public void xsetCount(org.apache.xmlbeans.XmlUnsignedInt r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTCacheFieldsImpl.xsetCount(org.apache.xmlbeans.XmlUnsignedInt):void");
    }
