...
public class CTPageFieldsImpl extends XmlComplexContentImpl implements CTPageFields {
    ...
    public List<CTPageField> getPageFieldList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTPageFieldsImpl$$ExternalSyntheticLambda0(this), new CTPageFieldsImpl$$ExternalSyntheticLambda1(this), new CTPageFieldsImpl$$ExternalSyntheticLambda2(this), new CTPageFieldsImpl$$ExternalSyntheticLambda3(this), new CTPageFieldsImpl$$ExternalSyntheticLambda4(this));
        }
        return javaListXmlObject;
    }

    public CTPageField[] getPageFieldArray() {
        return (CTPageField[]) getXmlObjectArray(PROPERTY_QNAME[0], (T[]) new CTPageField[0]);
    }
    ...
    public CTPageField getPageFieldArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPageField = (CTPageField) get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (cTPageField == null) {
    ...
    public void setPageFieldArray(CTPageField[] cTPageFieldArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTPageFieldArr, PROPERTY_QNAME[0]);
    }

    public void setPageFieldArray(int i, CTPageField cTPageField) {
        generatedSetterHelperImpl(cTPageField, PROPERTY_QNAME[0], i, 2);
    }
    ...
    public CTPageField insertNewPageField(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPageField = (CTPageField) get_store().insert_element_user(PROPERTY_QNAME[0], i);
        }
        return cTPageField;
    }
    ...
    public void setCount(long r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTPageFieldsImpl.setCount(long):void");
    }
    ...
    public void xsetCount(org.apache.xmlbeans.XmlUnsignedInt r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTPageFieldsImpl.xsetCount(org.apache.xmlbeans.XmlUnsignedInt):void");
    }
