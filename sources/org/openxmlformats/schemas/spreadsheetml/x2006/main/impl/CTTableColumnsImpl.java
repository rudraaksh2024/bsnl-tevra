...
public class CTTableColumnsImpl extends XmlComplexContentImpl implements CTTableColumns {
    ...
    public List<CTTableColumn> getTableColumnList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTableColumnsImpl$$ExternalSyntheticLambda0(this), new CTTableColumnsImpl$$ExternalSyntheticLambda1(this), new CTTableColumnsImpl$$ExternalSyntheticLambda2(this), new CTTableColumnsImpl$$ExternalSyntheticLambda3(this), new CTTableColumnsImpl$$ExternalSyntheticLambda4(this));
        }
        return javaListXmlObject;
    }

    public CTTableColumn[] getTableColumnArray() {
        return (CTTableColumn[]) getXmlObjectArray(PROPERTY_QNAME[0], (T[]) new CTTableColumn[0]);
    }
    ...
    public CTTableColumn getTableColumnArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTableColumn = (CTTableColumn) get_store().find_element_user(PROPERTY_QNAME[0], i);
    ...
    public void setTableColumnArray(CTTableColumn[] cTTableColumnArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTTableColumnArr, PROPERTY_QNAME[0]);
    }

    public void setTableColumnArray(int i, CTTableColumn cTTableColumn) {
        generatedSetterHelperImpl(cTTableColumn, PROPERTY_QNAME[0], i, 2);
    }
    ...
    public CTTableColumn insertNewTableColumn(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTableColumn = (CTTableColumn) get_store().insert_element_user(PROPERTY_QNAME[0], i);
        }
        return cTTableColumn;
    }
    ...
    public void setCount(long r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTTableColumnsImpl.setCount(long):void");
    }
    ...
    public void xsetCount(org.apache.xmlbeans.XmlUnsignedInt r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTTableColumnsImpl.xsetCount(org.apache.xmlbeans.XmlUnsignedInt):void");
    }
