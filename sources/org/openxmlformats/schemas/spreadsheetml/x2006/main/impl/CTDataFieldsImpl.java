...
public class CTDataFieldsImpl extends XmlComplexContentImpl implements CTDataFields {
    ...
    public List<CTDataField> getDataFieldList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTDataFieldsImpl$$ExternalSyntheticLambda0(this), new CTDataFieldsImpl$$ExternalSyntheticLambda1(this), new CTDataFieldsImpl$$ExternalSyntheticLambda2(this), new CTDataFieldsImpl$$ExternalSyntheticLambda3(this), new CTDataFieldsImpl$$ExternalSyntheticLambda4(this));
        }
        return javaListXmlObject;
    }

    public CTDataField[] getDataFieldArray() {
        return (CTDataField[]) getXmlObjectArray(PROPERTY_QNAME[0], (T[]) new CTDataField[0]);
    }
    ...
    public CTDataField getDataFieldArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTDataField = (CTDataField) get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (cTDataField == null) {
    ...
    public void setDataFieldArray(CTDataField[] cTDataFieldArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTDataFieldArr, PROPERTY_QNAME[0]);
    }

    public void setDataFieldArray(int i, CTDataField cTDataField) {
        generatedSetterHelperImpl(cTDataField, PROPERTY_QNAME[0], i, 2);
    }
    ...
    public CTDataField insertNewDataField(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTDataField = (CTDataField) get_store().insert_element_user(PROPERTY_QNAME[0], i);
        }
        return cTDataField;
    }
    ...
    public void setCount(long r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTDataFieldsImpl.setCount(long):void");
    }
    ...
    public void xsetCount(org.apache.xmlbeans.XmlUnsignedInt r6) {
        ...
        L_0x002b:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTDataFieldsImpl.xsetCount(org.apache.xmlbeans.XmlUnsignedInt):void");
    }
