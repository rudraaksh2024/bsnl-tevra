...
public class CTTcImpl extends XmlComplexContentImpl implements CTTc {
    ...
    public void setTcPr(CTTcPr cTTcPr) {
        generatedSetterHelperImpl(cTTcPr, PROPERTY_QNAME[0], 0, 1);
    }
    ...
    public List<CTCustomXmlBlock> getCustomXmlList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda105(this), new CTTcImpl$$ExternalSyntheticLambda116(this), new CTTcImpl$$ExternalSyntheticLambda127(this), new CTTcImpl$$ExternalSyntheticLambda138(this), new CTTcImpl$$ExternalSyntheticLambda149(this));
        }
        return javaListXmlObject;
    }

    public CTCustomXmlBlock[] getCustomXmlArray() {
        return getXmlObjectArray(PROPERTY_QNAME[1], (T[]) new CTCustomXmlBlock[0]);
    }
    ...
    public void setCustomXmlArray(int i, CTCustomXmlBlock cTCustomXmlBlock) {
        generatedSetterHelperImpl(cTCustomXmlBlock, PROPERTY_QNAME[1], i, 2);
    }
    ...
    public List<CTSdtBlock> getSdtList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda144(this), new CTTcImpl$$ExternalSyntheticLambda145(this), new CTTcImpl$$ExternalSyntheticLambda146(this), new CTTcImpl$$ExternalSyntheticLambda147(this), new CTTcImpl$$ExternalSyntheticLambda148(this));
        }
        return javaListXmlObject;
    }

    public CTSdtBlock[] getSdtArray() {
        return (CTSdtBlock[]) getXmlObjectArray(PROPERTY_QNAME[2], (T[]) new CTSdtBlock[0]);
    }
    ...
    public CTSdtBlock getSdtArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTSdtBlock = (CTSdtBlock) get_store().find_element_user(PROPERTY_QNAME[2], i);
            if (cTSdtBlock == null) {
                throw new IndexOutOfBoundsException();
            }
        }
    ...
    public void setSdtArray(CTSdtBlock[] cTSdtBlockArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTSdtBlockArr, PROPERTY_QNAME[2]);
    }

    public void setSdtArray(int i, CTSdtBlock cTSdtBlock) {
        generatedSetterHelperImpl(cTSdtBlock, PROPERTY_QNAME[2], i, 2);
    }
    ...
    public CTSdtBlock insertNewSdt(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTSdtBlock = (CTSdtBlock) get_store().insert_element_user(PROPERTY_QNAME[2], i);
        }
        return cTSdtBlock;
    }
    ...
    public List<CTP> getPList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda1(this), new CTTcImpl$$ExternalSyntheticLambda2(this), new CTTcImpl$$ExternalSyntheticLambda3(this), new CTTcImpl$$ExternalSyntheticLambda4(this), new CTTcImpl$$ExternalSyntheticLambda5(this));
        }
        return javaListXmlObject;
    }

    public CTP[] getPArray() {
        return (CTP[]) getXmlObjectArray(PROPERTY_QNAME[3], (T[]) new CTP[0]);
    }
    ...
    public CTP getPArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            ctp = (CTP) get_store().find_element_user(PROPERTY_QNAME[3], i);
            if (ctp == null) {
                throw new IndexOutOfBoundsException();
            }
        }
    ...
    public void setPArray(CTP[] ctpArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) ctpArr, PROPERTY_QNAME[3]);
    }

    public void setPArray(int i, CTP ctp) {
        generatedSetterHelperImpl(ctp, PROPERTY_QNAME[3], i, 2);
    }
    ...
    public CTP insertNewP(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            ctp = (CTP) get_store().insert_element_user(PROPERTY_QNAME[3], i);
        }
        return ctp;
    }
    ...
    public List<CTTbl> getTblList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda50(this), new CTTcImpl$$ExternalSyntheticLambda51(this), new CTTcImpl$$ExternalSyntheticLambda52(this), new CTTcImpl$$ExternalSyntheticLambda53(this), new CTTcImpl$$ExternalSyntheticLambda54(this));
        }
        return javaListXmlObject;
    }

    public CTTbl[] getTblArray() {
        return (CTTbl[]) getXmlObjectArray(PROPERTY_QNAME[4], (T[]) new CTTbl[0]);
    }
    ...
    public CTTbl getTblArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTbl = (CTTbl) get_store().find_element_user(PROPERTY_QNAME[4], i);
            if (cTTbl == null) {
                throw new IndexOutOfBoundsException();
            }
        }
    ...
    public void setTblArray(CTTbl[] cTTblArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTTblArr, PROPERTY_QNAME[4]);
    }

    public void setTblArray(int i, CTTbl cTTbl) {
        generatedSetterHelperImpl(cTTbl, PROPERTY_QNAME[4], i, 2);
    }
    ...
    public CTTbl insertNewTbl(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTbl = (CTTbl) get_store().insert_element_user(PROPERTY_QNAME[4], i);
        }
        return cTTbl;
    }
    ...
    public List<CTProofErr> getProofErrList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda78(this), new CTTcImpl$$ExternalSyntheticLambda79(this), new CTTcImpl$$ExternalSyntheticLambda80(this), new CTTcImpl$$ExternalSyntheticLambda81(this), new CTTcImpl$$ExternalSyntheticLambda82(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTPermStart> getPermStartList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda67(this), new CTTcImpl$$ExternalSyntheticLambda68(this), new CTTcImpl$$ExternalSyntheticLambda69(this), new CTTcImpl$$ExternalSyntheticLambda70(this), new CTTcImpl$$ExternalSyntheticLambda71(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTPerm> getPermEndList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda17(this), new CTTcImpl$$ExternalSyntheticLambda18(this), new CTTcImpl$$ExternalSyntheticLambda19(this), new CTTcImpl$$ExternalSyntheticLambda20(this), new CTTcImpl$$ExternalSyntheticLambda21(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTBookmark> getBookmarkStartList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda122(this), new CTTcImpl$$ExternalSyntheticLambda123(this), new CTTcImpl$$ExternalSyntheticLambda124(this), new CTTcImpl$$ExternalSyntheticLambda125(this), new CTTcImpl$$ExternalSyntheticLambda126(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMarkupRange> getBookmarkEndList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda139(this), new CTTcImpl$$ExternalSyntheticLambda140(this), new CTTcImpl$$ExternalSyntheticLambda141(this), new CTTcImpl$$ExternalSyntheticLambda142(this), new CTTcImpl$$ExternalSyntheticLambda143(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMoveBookmark> getMoveFromRangeStartList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda84(this), new CTTcImpl$$ExternalSyntheticLambda85(this), new CTTcImpl$$ExternalSyntheticLambda86(this), new CTTcImpl$$ExternalSyntheticLambda87(this), new CTTcImpl$$ExternalSyntheticLambda88(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMarkupRange> getMoveFromRangeEndList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda12(this), new CTTcImpl$$ExternalSyntheticLambda13(this), new CTTcImpl$$ExternalSyntheticLambda14(this), new CTTcImpl$$ExternalSyntheticLambda15(this), new CTTcImpl$$ExternalSyntheticLambda16(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMoveBookmark> getMoveToRangeStartList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda106(this), new CTTcImpl$$ExternalSyntheticLambda107(this), new CTTcImpl$$ExternalSyntheticLambda108(this), new CTTcImpl$$ExternalSyntheticLambda109(this), new CTTcImpl$$ExternalSyntheticLambda110(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMarkupRange> getMoveToRangeEndList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda128(this), new CTTcImpl$$ExternalSyntheticLambda129(this), new CTTcImpl$$ExternalSyntheticLambda130(this), new CTTcImpl$$ExternalSyntheticLambda131(this), new CTTcImpl$$ExternalSyntheticLambda132(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMarkupRange> getCommentRangeStartList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda39(this), new CTTcImpl$$ExternalSyntheticLambda40(this), new CTTcImpl$$ExternalSyntheticLambda41(this), new CTTcImpl$$ExternalSyntheticLambda42(this), new CTTcImpl$$ExternalSyntheticLambda43(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMarkupRange> getCommentRangeEndList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda111(this), new CTTcImpl$$ExternalSyntheticLambda112(this), new CTTcImpl$$ExternalSyntheticLambda113(this), new CTTcImpl$$ExternalSyntheticLambda114(this), new CTTcImpl$$ExternalSyntheticLambda115(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTTrackChange> getCustomXmlInsRangeStartList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda100(this), new CTTcImpl$$ExternalSyntheticLambda101(this), new CTTcImpl$$ExternalSyntheticLambda102(this), new CTTcImpl$$ExternalSyntheticLambda103(this), new CTTcImpl$$ExternalSyntheticLambda104(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMarkup> getCustomXmlInsRangeEndList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda133(this), new CTTcImpl$$ExternalSyntheticLambda134(this), new CTTcImpl$$ExternalSyntheticLambda135(this), new CTTcImpl$$ExternalSyntheticLambda136(this), new CTTcImpl$$ExternalSyntheticLambda137(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTTrackChange> getCustomXmlDelRangeStartList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda45(this), new CTTcImpl$$ExternalSyntheticLambda46(this), new CTTcImpl$$ExternalSyntheticLambda47(this), new CTTcImpl$$ExternalSyntheticLambda48(this), new CTTcImpl$$ExternalSyntheticLambda49(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMarkup> getCustomXmlDelRangeEndList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda56(this), new CTTcImpl$$ExternalSyntheticLambda57(this), new CTTcImpl$$ExternalSyntheticLambda58(this), new CTTcImpl$$ExternalSyntheticLambda59(this), new CTTcImpl$$ExternalSyntheticLambda60(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTTrackChange> getCustomXmlMoveFromRangeStartList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda89(this), new CTTcImpl$$ExternalSyntheticLambda90(this), new CTTcImpl$$ExternalSyntheticLambda91(this), new CTTcImpl$$ExternalSyntheticLambda92(this), new CTTcImpl$$ExternalSyntheticLambda93(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMarkup> getCustomXmlMoveFromRangeEndList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda6(this), new CTTcImpl$$ExternalSyntheticLambda7(this), new CTTcImpl$$ExternalSyntheticLambda8(this), new CTTcImpl$$ExternalSyntheticLambda9(this), new CTTcImpl$$ExternalSyntheticLambda10(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTTrackChange> getCustomXmlMoveToRangeStartList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda11(this), new CTTcImpl$$ExternalSyntheticLambda22(this), new CTTcImpl$$ExternalSyntheticLambda33(this), new CTTcImpl$$ExternalSyntheticLambda44(this), new CTTcImpl$$ExternalSyntheticLambda55(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTMarkup> getCustomXmlMoveToRangeEndList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda117(this), new CTTcImpl$$ExternalSyntheticLambda118(this), new CTTcImpl$$ExternalSyntheticLambda119(this), new CTTcImpl$$ExternalSyntheticLambda120(this), new CTTcImpl$$ExternalSyntheticLambda121(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTRunTrackChange> getInsList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda23(this), new CTTcImpl$$ExternalSyntheticLambda24(this), new CTTcImpl$$ExternalSyntheticLambda25(this), new CTTcImpl$$ExternalSyntheticLambda26(this), new CTTcImpl$$ExternalSyntheticLambda27(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTRunTrackChange> getDelList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda73(this), new CTTcImpl$$ExternalSyntheticLambda74(this), new CTTcImpl$$ExternalSyntheticLambda75(this), new CTTcImpl$$ExternalSyntheticLambda76(this), new CTTcImpl$$ExternalSyntheticLambda77(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTRunTrackChange> getMoveFromList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda95(this), new CTTcImpl$$ExternalSyntheticLambda96(this), new CTTcImpl$$ExternalSyntheticLambda97(this), new CTTcImpl$$ExternalSyntheticLambda98(this), new CTTcImpl$$ExternalSyntheticLambda99(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTRunTrackChange> getMoveToList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda62(this), new CTTcImpl$$ExternalSyntheticLambda63(this), new CTTcImpl$$ExternalSyntheticLambda64(this), new CTTcImpl$$ExternalSyntheticLambda65(this), new CTTcImpl$$ExternalSyntheticLambda66(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTOMathPara> getOMathParaList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda0(this), new CTTcImpl$$ExternalSyntheticLambda61(this), new CTTcImpl$$ExternalSyntheticLambda72(this), new CTTcImpl$$ExternalSyntheticLambda83(this), new CTTcImpl$$ExternalSyntheticLambda94(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTOMath> getOMathList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda34(this), new CTTcImpl$$ExternalSyntheticLambda35(this), new CTTcImpl$$ExternalSyntheticLambda36(this), new CTTcImpl$$ExternalSyntheticLambda37(this), new CTTcImpl$$ExternalSyntheticLambda38(this));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTAltChunk> getAltChunkList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new CTTcImpl$$ExternalSyntheticLambda28(this), new CTTcImpl$$ExternalSyntheticLambda29(this), new CTTcImpl$$ExternalSyntheticLambda30(this), new CTTcImpl$$ExternalSyntheticLambda31(this), new CTTcImpl$$ExternalSyntheticLambda32(this));
        }
        return javaListXmlObject;
    }

    public CTAltChunk[] getAltChunkArray() {
        return (CTAltChunk[]) getXmlObjectArray(PROPERTY_QNAME[30], (T[]) new CTAltChunk[0]);
    }
    ...
    public CTAltChunk getAltChunkArray(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTAltChunk = (CTAltChunk) get_store().find_element_user(PROPERTY_QNAME[30], i);
            if (cTAltChunk == null) {
                throw new IndexOutOfBoundsException();
            }
        }
    ...
    public void setAltChunkArray(CTAltChunk[] cTAltChunkArr) {
        check_orphaned();
        arraySetterHelper((XmlObject[]) cTAltChunkArr, PROPERTY_QNAME[30]);
    }

    public void setAltChunkArray(int i, CTAltChunk cTAltChunk) {
        generatedSetterHelperImpl(cTAltChunk, PROPERTY_QNAME[30], i, 2);
    }
    ...
    public CTAltChunk insertNewAltChunk(int i) {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTAltChunk = (CTAltChunk) get_store().insert_element_user(PROPERTY_QNAME[30], i);
        }
        return cTAltChunk;
    }
    ...
    public void setId(java.lang.String r6) {
        ...
        L_0x002c:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.setId(java.lang.String):void");
    }

    /* JADX WARNING: type inference failed for: r5v3, types: [org.apache.xmlbeans.impl.values.TypeStoreUser] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void xsetId(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString r6) {
        /*
            r5 = this;
            java.lang.Object r0 = r5.monitor()
            monitor-enter(r0)
        ...
        L_0x002c:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.xsetId(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString):void");
    }
