...
enum TokeniserState {
    ...
    BeforeAttributeName {
        ...
        public void read(org.jsoup.parser.Tokeniser r3, org.jsoup.parser.CharacterReader r4) {
            ...
            L_0x002e:
                org.jsoup.parser.Token$Tag r2 = r3.tagPending
                r2.newAttribute()
                r4.unconsume()
                org.jsoup.parser.TokeniserState r2 = AttributeName
                r3.transition(r2)
                goto L_0x007d
            L_0x003c:
                r4.unconsume()
            ...
            L_0x0042:
                r3.emitTagPending()
                org.jsoup.parser.TokeniserState r2 = Data
                r3.transition(r2)
                goto L_0x007d
            L_0x004b:
                r3.eofError(r2)
                ...
                goto L_0x007d
            L_0x0054:
                org.jsoup.parser.TokeniserState r2 = SelfClosingStartTag
                r3.transition(r2)
                goto L_0x007d
            L_0x005a:
                r3.error((org.jsoup.parser.TokeniserState) r2)
                ...
                r2.newAttribute()
                org.jsoup.parser.Token$Tag r2 = r3.tagPending
                r2.appendAttributeName((char) r0)
                org.jsoup.parser.TokeniserState r2 = AttributeName
                r3.transition(r2)
                goto L_0x007d
            L_0x006d:
    ...
    AttributeValue_singleQuoted {
        ...
        public void read(Tokeniser tokeniser, CharacterReader characterReader) {
            ...
            if (consume == 0) {
                ...
                int[] consumeCharacterReference = tokeniser.consumeCharacterReference(Character.valueOf(Chars.QUOTE), true);
                if (consumeCharacterReference != null) {
                    tokeniser.tagPending.appendAttributeValue(consumeCharacterReference);
                } else {
                    tokeniser.tagPending.appendAttributeValue((char) Typography.amp);
    ...
    BogusComment {
        /* access modifiers changed from: package-private */
        public void read(Tokeniser tokeniser, CharacterReader characterReader) {
            tokeniser.commentPending.append(characterReader.consumeTo((char) Typography.greater));
            char current = characterReader.current();
    ...
    CommentStart {
        ...
        public void read(Tokeniser tokeniser, CharacterReader characterReader) {
            ...
            if (consume == 0) {
                tokeniser.error((TokeniserState) this);
                tokeniser.commentPending.append((char) TokeniserState.replacementChar);
    ...
    CommentEndDash {
        ...
        public void read(Tokeniser tokeniser, CharacterReader characterReader) {
            ...
            if (consume == 0) {
                tokeniser.error((TokeniserState) this);
                tokeniser.commentPending.append('-').append((char) TokeniserState.replacementChar);
                tokeniser.transition(Comment);
            } else if (consume == '-') {
    ...
    AfterDoctypeName {
        ...
        public void read(Tokeniser tokeniser, CharacterReader characterReader) {
            if (characterReader.isEmpty()) {
                ...
                tokeniser.emitDoctypePending();
                tokeniser.transition(Data);
            } else if (characterReader.matchesAny(9, 10, Chars.CR, 12, Chars.SPACE)) {
                characterReader.advance();
            } else if (characterReader.matches((char) Typography.greater)) {
                tokeniser.emitDoctypePending();
                tokeniser.advanceTransition(Data);
    ...
    static {
        attributeNameCharsSorted = new char[]{9, 10, 12, Chars.CR, Chars.SPACE, '\"', Chars.QUOTE, '/', Typography.less, Chars.EQ, Typography.greater};
        attributeValueUnquoted = new char[]{0, 9, 10, 12, Chars.CR, Chars.SPACE, '\"', Typography.amp, Chars.QUOTE, Typography.less, Chars.EQ, Typography.greater, '`'};
