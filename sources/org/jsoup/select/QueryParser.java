...
public class QueryParser {
    ...
    /* JADX WARNING: type inference failed for: r11v4, types: [org.jsoup.select.CombiningEvaluator$And] */
    ...
    private void byTag() {
        ...
        if (normalize.startsWith("*|")) {
            ...
            this.evals.add(new CombiningEvaluator.Or(new Evaluator.Tag(substring), new Evaluator.TagEndsWith(normalize.replace("*|", ParameterizedMessage.ERROR_MSG_SEPARATOR))));
            return;
        }
        if (normalize.contains("|")) {
            normalize = normalize.replace("|", ParameterizedMessage.ERROR_MSG_SEPARATOR);
        }
