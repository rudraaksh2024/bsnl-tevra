...
public class FileSystemUtils {
    ...
    public long freeSpaceUnix(String str, boolean z, boolean z2, Duration duration) throws IOException {
        if (!str.isEmpty()) {
            String str2 = z ? "-k" : ProcessIdUtil.DEFAULT_PROCESSID;
            if (z2) {
                str2 = str2 + "P";
            }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v1, resolved type: java.io.BufferedReader} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v5, resolved type: java.io.OutputStream} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v8, resolved type: java.io.OutputStream} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v7, resolved type: java.io.InputStream} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v9, resolved type: java.io.OutputStream} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v10, resolved type: java.io.OutputStream} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v11, resolved type: java.io.OutputStream} */
    ...
    public java.util.List<java.lang.String> performCommand(java.lang.String[] r10, int r11, java.time.Duration r12) throws java.io.IOException {
        /*
            ...
            r0.<init>(r1)
            r1 = 0
            java.lang.Thread r2 = org.apache.commons.io.ThreadMonitor.start(r12)     // Catch:{ InterruptedException -> 0x00fa, all -> 0x00f4 }
            java.lang.Process r9 = r9.openProcess(r10)     // Catch:{ InterruptedException -> 0x00fa, all -> 0x00f4 }
            java.io.InputStream r3 = r9.getInputStream()     // Catch:{ InterruptedException -> 0x00ed, all -> 0x00ea }
            java.io.OutputStream r4 = r9.getOutputStream()     // Catch:{ InterruptedException -> 0x00e7, all -> 0x00e2 }
            java.io.InputStream r5 = r9.getErrorStream()     // Catch:{ InterruptedException -> 0x00df, all -> 0x00dc }
            java.io.BufferedReader r6 = new java.io.BufferedReader     // Catch:{ InterruptedException -> 0x00d9, all -> 0x00d5 }
            java.io.InputStreamReader r7 = new java.io.InputStreamReader     // Catch:{ InterruptedException -> 0x00d9, all -> 0x00d5 }
            java.nio.charset.Charset r8 = java.nio.charset.Charset.defaultCharset()     // Catch:{ InterruptedException -> 0x00d9, all -> 0x00d5 }
            r7.<init>(r3, r8)     // Catch:{ InterruptedException -> 0x00d9, all -> 0x00d5 }
            r6.<init>(r7)     // Catch:{ InterruptedException -> 0x00d9, all -> 0x00d5 }
            java.lang.String r7 = r6.readLine()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
        L_0x002e:
            if (r7 == 0) goto L_0x0048
            int r8 = r0.size()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            if (r8 >= r11) goto L_0x0048
            java.util.Locale r8 = java.util.Locale.ENGLISH     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            java.lang.String r7 = r7.toLowerCase(r8)     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            java.lang.String r7 = r7.trim()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            r0.add(r7)     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            java.lang.String r7 = r6.readLine()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            goto L_0x002e
        L_0x0048:
            r9.waitFor()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            org.apache.commons.io.ThreadMonitor.stop(r2)     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            int r11 = r9.exitValue()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            if (r11 != 0) goto L_0x00a5
            boolean r11 = r0.isEmpty()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            if (r11 != 0) goto L_0x0088
            r6.close()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            r3.close()     // Catch:{ InterruptedException -> 0x00d9, all -> 0x00d5 }
            if (r4 == 0) goto L_0x0070
            r4.close()     // Catch:{ InterruptedException -> 0x006b, all -> 0x0067 }
            r4 = r1
            goto L_0x0070
        L_0x0067:
            r10 = move-exception
        ...
        L_0x0087:
            return r0
        L_0x0088:
            java.io.IOException r11 = new java.io.IOException     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            ...
            java.util.List r1 = java.util.Arrays.asList(r10)     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            java.lang.String r0 = r0.toString()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            r11.<init>(r0)     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            throw r11     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
        L_0x00a5:
            java.io.IOException r11 = new java.io.IOException     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            r0.<init>()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            ...
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            int r1 = r9.exitValue()     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ InterruptedException -> 0x00d3, all -> 0x00d0 }
        ...
        L_0x00ff:
            ...
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x0126 }
            java.util.List r10 = java.util.Arrays.asList(r10)     // Catch:{ all -> 0x0126 }
            java.lang.StringBuilder r10 = r0.append(r10)     // Catch:{ all -> 0x0126 }
            java.lang.String r0 = " timeout="
            java.lang.StringBuilder r10 = r10.append(r0)     // Catch:{ all -> 0x0126 }
            java.lang.StringBuilder r10 = r10.append(r12)     // Catch:{ all -> 0x0126 }
