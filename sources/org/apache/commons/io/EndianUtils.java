...
public class EndianUtils {
    ...
    public static int readSwappedInteger(byte[] bArr, int i) {
        return ((bArr[i + 0] & UByte.MAX_VALUE) << 0) + ((bArr[i + 1] & UByte.MAX_VALUE) << 8) + ((bArr[i + 2] & UByte.MAX_VALUE) << UnionPtg.sid) + ((bArr[i + 3] & UByte.MAX_VALUE) << 24);
    }

    public static long readSwappedUnsignedInteger(byte[] bArr, int i) {
        return (((long) (bArr[i + 3] & UByte.MAX_VALUE)) << 24) + (((long) (((bArr[i + 0] & UByte.MAX_VALUE) << 0) + ((bArr[i + 1] & UByte.MAX_VALUE) << 8) + ((bArr[i + 2] & UByte.MAX_VALUE) << UnionPtg.sid))) & 4294967295L);
    }
