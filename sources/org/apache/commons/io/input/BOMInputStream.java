...
public class BOMInputStream extends ProxyInputStream {
    private static final Comparator<ByteOrderMark> ByteOrderMarkLengthComparator = new BOMInputStream$$ExternalSyntheticLambda0();
    ...
    public BOMInputStream(InputStream inputStream, boolean z, ByteOrderMark... byteOrderMarkArr) {
        super(inputStream);
        if (IOUtils.length((Object[]) byteOrderMarkArr) != 0) {
            this.include = z;
