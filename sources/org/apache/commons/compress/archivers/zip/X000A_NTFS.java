...
public class X000A_NTFS implements ZipExtraField {
    ...
    public String toString() {
        ...
        sb.append(getModifyJavaTime()).append("]  Access:[").append(getAccessJavaTime()).append("]  Create:[").append(getCreateJavaTime()).append("] ");
        return sb.toString();
    }
    ...
    private static ZipEightByteInteger dateToZip(Date date) {
        ...
        return new ZipEightByteInteger((date.getTime() * DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM) - EPOCH_OFFSET);
    }
    ...
    private static Date zipToDate(ZipEightByteInteger zipEightByteInteger) {
        ...
        return new Date((zipEightByteInteger.getLongValue() + EPOCH_OFFSET) / DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM);
    }
}
