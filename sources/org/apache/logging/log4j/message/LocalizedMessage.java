...
public class LocalizedMessage implements Message, LoggerNameAwareMessage {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public LocalizedMessage(ResourceBundle resourceBundle2, String str) {
        this(resourceBundle2, (Locale) null, str, new Object[0]);
        Locale locale2 = null;
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:26:0x0056 A[EDGE_INSN: B:26:0x0056->B:23:0x0056 ?: BREAK  , SYNTHETIC] */
    protected java.util.ResourceBundle getResourceBundle(java.lang.String r4, java.util.Locale r5, boolean r6) {
        ...
        L_0x0013:
            ...
            org.apache.logging.log4j.status.StatusLogger r3 = r3.logger
        ...
        L_0x0028:
            ...
            java.util.ResourceBundle r6 = java.util.ResourceBundle.getBundle(r4, r5)     // Catch:{ MissingResourceException -> 0x0043 }
            goto L_0x0011
        L_0x003e:
            java.util.ResourceBundle r6 = java.util.ResourceBundle.getBundle(r4)     // Catch:{ MissingResourceException -> 0x0043 }
            goto L_0x0011
        L_0x0043:
