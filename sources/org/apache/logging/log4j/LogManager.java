...
public class LogManager {
    ...
    static {
        ...
        if (stringProperty != null) {
            try {
                ...
                LOGGER.error("Unable to locate configured LoggerContextFactory {}", (Object) stringProperty);
            } catch (Exception e) {
                LOGGER.error("Unable to create configured LoggerContextFactory {}", (Object) stringProperty, (Object) e);
            }
        }
        if (factory == null) {
                ...
                for (Provider next : ProviderUtil.getProviders()) {
                    ...
                    if (loadLoggerContextFactory != null) {
                        try {
                            ...
                            LOGGER.error("Unable to create class {} specified in provider URL {}", (Object) loadLoggerContextFactory.getName(), (Object) next.getUrl(), (Object) e2);
                        }
                    }
                }
                if (treeMap.isEmpty()) {
                    ...
                    for (Map.Entry entry : treeMap.entrySet()) {
                        ...
                        sb.append(", Weighting: ").append(entry.getKey()).append(10);
                    }
                    factory = (LoggerContextFactory) treeMap.get(treeMap.lastKey());
    ...
    public static LoggerContext getContext(boolean z) {
        try {
            ...
            LOGGER.warn(e.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(FQCN, (ClassLoader) null, (Object) null, z, (URI) null, (String) null);
        }
    }
    ...
    public static LoggerContext getContext(ClassLoader classLoader, boolean z) {
        try {
            ...
            LOGGER.warn(e.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(FQCN, classLoader, (Object) null, z);
        }
    }
    ...
    public static LoggerContext getContext(ClassLoader classLoader, boolean z, URI uri) {
        try {
            ...
            LOGGER.warn(e.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(FQCN, classLoader, (Object) null, z, uri, (String) null);
        }
    }
    ...
    public static LoggerContext getContext(ClassLoader classLoader, boolean z, Object obj, URI uri) {
        try {
            ...
            LOGGER.warn(e.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(FQCN, classLoader, obj, z, uri, (String) null);
        }
    }
    ...
    protected static LoggerContext getContext(String str, boolean z) {
        try {
            ...
            LOGGER.warn(e.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(str, (ClassLoader) null, (Object) null, z);
        }
    }
    ...
    protected static LoggerContext getContext(String str, ClassLoader classLoader, boolean z) {
        try {
            ...
            LOGGER.warn(e.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(str, classLoader, (Object) null, z);
        }
    }

    protected static LoggerContext getContext(String str, ClassLoader classLoader, boolean z, URI uri, String str2) {
        try {
            return factory.getContext(str, classLoader, (Object) null, z, uri, str2);
        } catch (IllegalStateException e) {
            LOGGER.warn(e.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(str, classLoader, (Object) null, z);
        }
    ...
    public static void shutdown(boolean z) {
        factory.shutdown(FQCN, (ClassLoader) null, z, false);
    }

    public static void shutdown(boolean z, boolean z2) {
        factory.shutdown(FQCN, (ClassLoader) null, z, z2);
    }
    ...
    public static Logger getLogger(String str, MessageFactory messageFactory) {
        return str != null ? getContext(false).getLogger(str, messageFactory) : getLogger(StackLocatorUtil.getCallerClass(2), messageFactory);
    }
