...
public class XMLChar {
    ...
    public static char lowSurrogate(int i) {
        return (char) (((i - 65536) & IEEEDouble.EXPONENT_BIAS) + 56320);
    }
    ...
    static {
        ...
        int[] iArr14 = {183, 720, 721, TypedValues.Custom.TYPE_STRING, 1600, 3654, 3782, 12293};
        ...
        for (int i27 = 0; i27 < 9; i27++) {
            byte[] bArr14 = CHARS;
            int i28 = iArr6[i27];
            bArr14[i28] = (byte) (bArr14[i28] | UnionPtg.sid);
        }
        for (int i29 = 0; i29 < 6; i29 += 2) {
            for (int i30 = iArr17[i29]; i30 <= iArr17[i29 + 1]; i30++) {
                byte[] bArr15 = CHARS;
                bArr15[i30] = (byte) (bArr15[i30] | UnionPtg.sid);
            }
        }
    }
