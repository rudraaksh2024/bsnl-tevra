...
public abstract class PushedInputStream extends InputStream {
    ...
    public abstract void fill(int i) throws IOException;
    ...
    public synchronized long skip(long j) throws IOException {
        ...
        long j2 = (long) (this.writepos - this.readpos);
        if (j2 < j) {
            long j3 = j - j2;
            if (j3 > 2147483647L) {
                j3 = 2147483647L;
            ...
            fill((int) j3);
            j2 = (long) (this.writepos - this.readpos);
            if (j2 <= 0) {
                return 0;
            }
        }
        ...
        this.readpos = (int) (((long) this.readpos) + j);
        return j;
    }
