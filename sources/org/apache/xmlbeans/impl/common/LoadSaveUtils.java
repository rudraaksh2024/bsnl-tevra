            ...
            switch (xMLStreamReader.getEventType()) {
                case 1:
                    ...
                    for (int attributeCount = xMLStreamReader.getAttributeCount() - 1; attributeCount >= 0; attributeCount--) {
                        if (xMLStreamReader.getAttributePrefix(attributeCount) == null) {
                            str = "";
                        } else {
                            str = xMLStreamReader.getAttributePrefix(attributeCount);
                        }
                        createXMLStreamWriter.writeAttribute(str, xMLStreamReader.getAttributeNamespace(attributeCount), xMLStreamReader.getAttributeLocalName(attributeCount), xMLStreamReader.getAttributeValue(attributeCount));
                    }
