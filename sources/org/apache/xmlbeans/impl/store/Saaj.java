...
public interface Saaj {
    ...
    SOAPFault soapBody_addFault(SOAPBody sOAPBody, Name name, String str, Locale locale) throws SOAPException;
    ...
    void soapFault_setFaultString(SOAPFault sOAPFault, String str, Locale locale);
