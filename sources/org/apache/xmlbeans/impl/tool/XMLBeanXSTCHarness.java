    ...
    public void runTestCase(XSTCTester.TestCaseResult testCaseResult) {
        ...
        if (testCase.getSchemaFile() != null) {
            ...
            try {
                ...
                schemaTypeLoader = XmlBeans.typeLoaderUnion(XmlBeans.compileXsd(parse2 == null ? new XmlObject[]{parse} : new XmlObject[]{parse, parse2}, XmlBeans.getBuiltinTypeSystem(), new XmlOptions().setErrorListener(arrayList)), XmlBeans.getBuiltinTypeSystem());
                z = true;
            } catch (Exception e) {
                if (!(e instanceof XmlException) || arrayList.isEmpty()) {
                    ...
                    testCaseResult.addSvMessages(Collections.singleton(XmlError.forMessage(stringWriter.toString())));
                }
            ...
            if (schemaTypeLoader != null && testCase.getInstanceFile() != null) {
                try {
                    ...
                    if (!(e2 instanceof XmlException) || arrayList.isEmpty()) {
                        ...
                        testCaseResult.addIvMessages(Collections.singleton(XmlError.forMessage(stringWriter2.toString())));
                    }
                }
