...
public final class LineFormatRecord extends StandardRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("lineColor", new LineFormatRecord$$ExternalSyntheticLambda0(this), "linePattern", GenericRecordUtil.getEnumBitsAsString(new LineFormatRecord$$ExternalSyntheticLambda1(this), new int[]{0, 1, 2, 3, 4, 5, 6, 7, 8}, new String[]{"SOLID", "DASH", "DOT", "DASH_DOT", "DASH_DOT_DOT", "NONE", "DARK_GRAY_PATTERN", "MEDIUM_GRAY_PATTERN", "LIGHT_GRAY_PATTERN"}), "weight", GenericRecordUtil.getEnumBitsAsString(new LineFormatRecord$$ExternalSyntheticLambda2(this), new int[]{-1, 0, 1, 2}, new String[]{"HAIRLINE", "NARROW", "MEDIUM", "WIDE"}), "format", GenericRecordUtil.getBitsAsString((Supplier<Number>) new LineFormatRecord$$ExternalSyntheticLambda3(this), new BitField[]{auto, drawTicks, unknown}, new String[]{"AUTO", "DRAWTICKS", "UNKNOWN"}), "colourPaletteIndex", new LineFormatRecord$$ExternalSyntheticLambda4(this));
    }
}
