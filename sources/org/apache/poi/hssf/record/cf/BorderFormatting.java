...
public final class BorderFormatting implements Duplicatable, GenericRecord {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        ...
        linkedHashMap.put(CellUtil.BORDER_LEFT, new BorderFormatting$$ExternalSyntheticLambda0(this));
        linkedHashMap.put(CellUtil.BORDER_RIGHT, new BorderFormatting$$ExternalSyntheticLambda1(this));
        linkedHashMap.put(CellUtil.BORDER_TOP, new BorderFormatting$$ExternalSyntheticLambda2(this));
        linkedHashMap.put(CellUtil.BORDER_BOTTOM, new BorderFormatting$$ExternalSyntheticLambda3(this));
        linkedHashMap.put(CellUtil.LEFT_BORDER_COLOR, new BorderFormatting$$ExternalSyntheticLambda4(this));
        linkedHashMap.put(CellUtil.RIGHT_BORDER_COLOR, new BorderFormatting$$ExternalSyntheticLambda5(this));
        linkedHashMap.put(CellUtil.TOP_BORDER_COLOR, new BorderFormatting$$ExternalSyntheticLambda6(this));
        linkedHashMap.put(CellUtil.BOTTOM_BORDER_COLOR, new BorderFormatting$$ExternalSyntheticLambda7(this));
        linkedHashMap.put("forwardDiagonalOn", new BorderFormatting$$ExternalSyntheticLambda8(this));
        linkedHashMap.put("backwardDiagonalOn", new BorderFormatting$$ExternalSyntheticLambda9(this));
    ...
    public int serialize(int i, byte[] bArr) {
        LittleEndian.putInt(bArr, i, this.field_13_border_styles1);
