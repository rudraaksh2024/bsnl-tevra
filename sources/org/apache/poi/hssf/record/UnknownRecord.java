...
public final class UnknownRecord extends StandardRecord {
    ...
    private static boolean isObservedButUnknown(int i) {
        if (i == 51 || i == 52 || i == 4170 || i == 4171 || i == 4174 || i == 4175 || i == 4188 || i == 4189) {
            return true;
        }
        switch (i) {
            case 445:
        ...
        switch (i) {
            ...
            default:
                if (isObservedButUnknown(i)) {
                    return "UNKNOWN-" + Integer.toHexString(i).toUpperCase(Locale.ROOT);
                }
                return null;
        }
    }
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("sid", new UnknownRecord$$ExternalSyntheticLambda1(this), "biffName", new UnknownRecord$$ExternalSyntheticLambda0(this), Constants.MessagePayloadKeys.RAW_DATA, new UnknownRecord$$ExternalSyntheticLambda2(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$getGenericProperties$0$org-apache-poi-hssf-record-UnknownRecord  reason: not valid java name */
    public /* synthetic */ String m2110lambda$getGenericProperties$0$orgapachepoihssfrecordUnknownRecord() {
    ...
    public /* synthetic */ Object m2111lambda$getGenericProperties$1$orgapachepoihssfrecordUnknownRecord() {
