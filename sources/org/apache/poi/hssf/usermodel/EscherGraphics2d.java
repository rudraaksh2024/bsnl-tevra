...
public final class EscherGraphics2d extends Graphics2D {
    ...
    public void drawImage(BufferedImage bufferedImage, BufferedImageOp bufferedImageOp, int i, int i2) {
        drawImage(bufferedImageOp.filter(bufferedImage, (BufferedImage) null), new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, (float) i, (float) i2), (ImageObserver) null);
    }
    ...
    public void drawString(AttributedCharacterIterator attributedCharacterIterator, float f, float f2) {
        ...
        Paint paint = getPaint();
        setColor(getColor());
        fill(textLayout.getOutline(AffineTransform.getTranslateInstance((double) f, (double) f2)));
        setPaint(paint);
    }
    ...
    public void fillArc(int i, int i2, int i3, int i4, int i5, int i6) {
        fill(new Arc2D.Float((float) i, (float) i2, (float) i3, (float) i4, (float) i5, (float) i6, 2));
    }
    ...
    public void translate(int i, int i2) {
        getTrans().translate((double) i, (double) i2);
    }
