...
public abstract class Property implements Child, POIFSViewable {
    ...
    protected Property(int i, byte[] bArr, int i2) {
        this._raw_data = Arrays.copyOfRange(bArr, i2, i2 + 128);
    ...
    public void setNextChild(Child child) {
        ...
        if (child == null) {
            ...
            i = ((Property) child).getIndex();
        }
        integerField.set(i, this._raw_data);
    }
    ...
    public Object[] getViewableArray() {
        return new Object[]{"Name          = \"" + getName() + "\"", "Property Type = " + this._property_type.get(), "Node Color    = " + this._node_color.get(), "Time 1        = " + ((((long) this._days_1.get()) << 32) + (((long) this._seconds_1.get()) & 65535)), "Time 2        = " + ((((long) this._days_2.get()) << 32) + (((long) this._seconds_2.get()) & 65535)), "Size          = " + getSize()};
    }
