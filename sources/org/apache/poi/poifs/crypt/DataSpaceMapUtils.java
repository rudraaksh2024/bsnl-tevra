...
public class DataSpaceMapUtils {
    public static void addDefaultDataSpace(DirectoryEntry directoryEntry) throws IOException {
        ...
        createEncryptionEntry(directoryEntry, "\u0006DataSpaces/TransformInfo/StrongEncryptionTransform/\u0006Primary", new IRMDSTransformInfo(new TransformInfoHeader(1, "{FF9A3F03-56EF-4613-BDD5-5A41C1D07246}", "Microsoft.Container.EncryptionTransform", 1, 0, 1, 0, 1, 0), 0, (String) null));
    ...
    public static DocumentEntry createEncryptionEntry(DirectoryEntry directoryEntry, String str, EncryptionRecord encryptionRecord) throws IOException {
        ...
        for (int i = 0; i < split.length - 1; i++) {
            if (directoryEntry.hasEntry(split[i])) {
                directoryEntry = (DirectoryEntry) directoryEntry.getEntry(split[i]);
            } else {
                directoryEntry = directoryEntry.createDirectory(split[i]);
            }
        }
        ...
        return directoryEntry.createDocument(str2, littleEndianByteArrayOutputStream.getWriteIndex(), new POIFSWriterListener() {
    ...
    public static class DataSpaceMap implements EncryptionRecord {
        ...
        public void write(LittleEndianByteArrayOutputStream littleEndianByteArrayOutputStream) {
            ...
            for (DataSpaceMapEntry write : this.entries) {
                write.write(littleEndianByteArrayOutputStream);
            }
        }
    }
    ...
    public static class DataSpaceDefinition implements EncryptionRecord {
        ...
        public void write(LittleEndianByteArrayOutputStream littleEndianByteArrayOutputStream) {
            ...
            for (String writeUnicodeLPP4 : this.transformer) {
                DataSpaceMapUtils.writeUnicodeLPP4(littleEndianByteArrayOutputStream, writeUnicodeLPP4);
            }
        }
    }
    ...
    public static class IRMDSTransformInfo implements EncryptionRecord {
        ...
        public IRMDSTransformInfo(TransformInfoHeader transformInfoHeader2, int i, String str) {
            this.transformInfoHeader = transformInfoHeader2;
    ...
    public static String readUtf8LPP4(LittleEndianInput littleEndianInput) {
        ...
        byte[] safelyAllocate = IOUtils.safelyAllocate((long) readInt, CryptoFunctions.MAX_RECORD_LENGTH);
