...
public final class CryptoFunctions {
    ...
    private static short rotateLeftBase15Bit(short s) {
        return (short) (((short) ((s << 1) & 32767)) | ((short) ((s & 16384) == 0 ? 0 : 1)));
    }
    ...
    public static Cipher getCipher(SecretKey secretKey, CipherAlgorithm cipherAlgorithm, ChainingMode chainingMode, byte[] bArr, int i) {
        return getCipher(secretKey, cipherAlgorithm, chainingMode, bArr, i, (String) null);
    }
            ...
            if (Cipher.getMaxAllowedKeyLength(cipherAlgorithm.jceId) >= length * 8) {
                ...
                if (bArr == null) {
                    ...
                    if (cipherAlgorithm == CipherAlgorithm.rc2) {
                        algorithmParameterSpec = new RC2ParameterSpec(key.getEncoded().length * 8, bArr);
                    } else {
    ...
    private static byte[] getBlock36(byte[] bArr, int i) {
        return getBlockX(bArr, i, TarConstants.LF_FIFO);
    }
        ...
        if (str != null) {
            ...
            if (!str.isEmpty()) {
                ...
                while (i2 < length2) {
                    ...
                    int i3 = length + 1;
                    for (int i4 : ENCRYPTION_MATRIX[length]) {
                        if ((b & 1) == 1) {
                            i ^= i4;
                        }
                        b = (byte) (b >>> 1);
    ...
    public static String xorHashPassword(String str) {
        ...
        return String.format(Locale.ROOT, "%1$08X", new Object[]{Integer.valueOf(createXorVerifier2)});
    }

    public static String xorHashPasswordReversed(String str) {
        int createXorVerifier2 = createXorVerifier2(str);
        return String.format(Locale.ROOT, "%1$02X%2$02X%3$02X%4$02X", new Object[]{Integer.valueOf(createXorVerifier2 & 255), Integer.valueOf((createXorVerifier2 >>> 8) & 255), Integer.valueOf((createXorVerifier2 >>> 16) & 255), Integer.valueOf((createXorVerifier2 >>> 24) & 255)});
    }
    ...
    public static byte[] createXorArray1(String str) {
        ...
        for (int i = 0; i < 16; i++) {
            byte b = (byte) (bArr[i] ^ bArr3[i & 1]);
            bArr[i] = b;
            bArr[i] = rotateLeft(b, 2);
        }
        return bArr;
    }
