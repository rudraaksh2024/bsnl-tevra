...
public enum CipherAlgorithm {
    ...
    rc2((String) null, "RC2", -1, 128, new int[]{40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120, 128}, 8, 20, "RC2", false),
    des((String) null, "DES", -1, 64, new int[]{64}, 8, 32, "DES", false),
    des3((String) null, "DESede", -1, 192, new int[]{192}, 8, 32, "3DES", false),
    des3_112((String) null, "DESede", -1, 128, new int[]{128}, 8, 32, "3DES_112", true),
    rsa((String) null, "RSA", -1, 1024, new int[]{1024, 2048, 3072, 4096}, -1, -1, "", false);
    ...
    private CipherAlgorithm(CipherProvider cipherProvider, String str, int i, int i2, int[] iArr, int i3, int i4, String str2, boolean z) {
    ...
    public static CipherAlgorithm fromXmlId(String str, int i) {
        ...
        throw new EncryptedDocumentException("cipher algorithm " + str + PackagingURIHelper.FORWARD_SLASH_STRING + i + " not found");
    }
}
