...
public class XDDFDoughnutChartData extends XDDFChartData {
    ...
    @Internal
    protected XDDFDoughnutChartData(XDDFChart xDDFChart, CTDoughnutChart cTDoughnutChart) {
        super(xDDFChart);
        this.chart = cTDoughnutChart;
        for (CTPieSer next : cTDoughnutChart.getSerList()) {
