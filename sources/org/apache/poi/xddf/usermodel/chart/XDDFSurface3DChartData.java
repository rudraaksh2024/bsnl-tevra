...
public class XDDFSurface3DChartData extends XDDFChartData {
    ...
    @Internal
    protected XDDFSurface3DChartData(XDDFChart xDDFChart, CTSurface3DChart cTSurface3DChart, Map<Long, XDDFChartAxis> map, Map<Long, XDDFValueAxis> map2) {
        super(xDDFChart);
        this.chart = cTSurface3DChart;
        for (CTSurfaceSer next : cTSurface3DChart.getSerList()) {
