...
public class XDDFLineChartData extends XDDFChartData {
    ...
    @Internal
    protected XDDFLineChartData(XDDFChart xDDFChart, CTLineChart cTLineChart, Map<Long, XDDFChartAxis> map, Map<Long, XDDFValueAxis> map2) {
        super(xDDFChart);
        this.chart = cTLineChart;
        for (CTLineSer next : cTLineChart.getSerList()) {
