...
public class XDDFBar3DChartData extends XDDFChartData {
    ...
    @Internal
    protected XDDFBar3DChartData(XDDFChart xDDFChart, CTBar3DChart cTBar3DChart, Map<Long, XDDFChartAxis> map, Map<Long, XDDFValueAxis> map2) {
        super(xDDFChart);
        this.chart = cTBar3DChart;
        if (cTBar3DChart.getBarDir() == null) {
            cTBar3DChart.addNewBarDir().setVal(BarDirection.BAR.underlying);
        }
        for (CTBarSer next : cTBar3DChart.getSerList()) {
