...
public class XDDFAreaChartData extends XDDFChartData {
    ...
    @Internal
    protected XDDFAreaChartData(XDDFChart xDDFChart, CTAreaChart cTAreaChart, Map<Long, XDDFChartAxis> map, Map<Long, XDDFValueAxis> map2) {
        super(xDDFChart);
        this.chart = cTAreaChart;
        for (CTAreaSer next : cTAreaChart.getSerList()) {
