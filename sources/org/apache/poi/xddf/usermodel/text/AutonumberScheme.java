...
public enum AutonumberScheme {
    ...
    private static final HashMap<STTextAutonumberScheme.Enum, AutonumberScheme> reverse = null;
    ...
    private AutonumberScheme(STTextAutonumberScheme.Enum enumR) {
        this.underlying = enumR;
    }

    static AutonumberScheme valueOf(STTextAutonumberScheme.Enum enumR) {
