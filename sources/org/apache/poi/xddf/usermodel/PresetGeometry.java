...
public enum PresetGeometry {
    ...
    private static final HashMap<STShapeType.Enum, PresetGeometry> reverse = null;
    final STShapeType.Enum underlying;

    static {
        reverse = new HashMap<>();
        for (PresetGeometry presetGeometry : values()) {
            reverse.put(presetGeometry.underlying, presetGeometry);
        }
    }

    private PresetGeometry(STShapeType.Enum enumR) {
        this.underlying = enumR;
    }

    static PresetGeometry valueOf(STShapeType.Enum enumR) {
