...
public enum ShapeType {
    ...
    NON_ISOSCELES_TRAPEZOID(9, -1, (int) null),
    PENTAGON(10, 56, "Pentagon"),
    HEXAGON(11, 9, "Hexagon"),
    HEPTAGON(12, -1, (int) null),
    OCTAGON(13, 10, "Octagon"),
    DECAGON(14, -1, (int) null),
    DODECAGON(15, -1, (int) null),
    STAR_4(16, 187, "Star4"),
    STAR_5(17, 12, "Star"),
    STAR_6(18, -1, (int) null),
    STAR_7(19, -1, (int) null),
    STAR_8(20, 58, "Star8"),
    STAR_10(21, -1, (int) null),
    STAR_12(22, -1, (int) null),
    STAR_16(23, 59, "Star16"),
    SEAL(23, 18, "Seal"),
    STAR_24(24, 92, "Star24"),
    STAR_32(25, 60, "Star32"),
    ROUND_RECT(26, 2, "RoundRectangle"),
    ROUND_1_RECT(27, -1, (int) null),
    ROUND_2_SAME_RECT(28, -1, (int) null),
    ROUND_2_DIAG_RECT(29, -1, (int) null),
    SNIP_ROUND_RECT(30, -1, (int) null),
    SNIP_1_RECT(31, -1, (int) null),
    SNIP_2_SAME_RECT(32, -1, (int) null),
    SNIP_2_DIAG_RECT(33, -1, (int) null),
    PLAQUE(34, 21, "Plaque"),
    ELLIPSE(35, 3, "Ellipse"),
    TEARDROP(36, -1, (int) null),
    HOME_PLATE(37, 15, "HomePlate"),
    CHEVRON(38, 55, "Chevron"),
    PIE_WEDGE(39, -1, (int) null),
    PIE(40, -1, (int) null),
    ...
    LEFT_CIRCULAR_ARROW(66, -1, (int) null),
    LEFT_RIGHT_CIRCULAR_ARROW(67, -1, (int) null),
    ...
    HALF_FRAME(85, -1, (int) null),
    CORNER(86, -1, (int) null),
    DIAG_STRIPE(87, -1, (int) null),
    CHORD(88, -1, (int) null),
    ARC(89, 19, "Arc"),
    ...
    GEAR_6(173, -1, (int) null),
    GEAR_9(174, -1, (int) null),
    FUNNEL(175, -1, (int) null),
    MATH_PLUS(176, -1, (int) null),
    MATH_MINUS(177, -1, (int) null),
    MATH_MULTIPLY(178, -1, (int) null),
    MATH_DIVIDE(179, -1, (int) null),
    MATH_EQUAL(180, -1, (int) null),
    MATH_NOT_EQUAL(181, -1, (int) null),
    CORNER_TABS(182, -1, (int) null),
    SQUARE_TABS(183, -1, (int) null),
    PLAQUE_TABS(184, -1, (int) null),
    CHART_X(185, -1, (int) null),
    CHART_STAR(186, -1, (int) null),
    CHART_PLUS(187, -1, (int) null),
        ...
        if (this.ooxmlId != -1) {
            ...
            for (char c : name().toCharArray()) {
                if (c == '_') {
                    ...
                    sb.append(z ? StringUtil.toLowerCase(c) : StringUtil.toUpperCase(c));
                    z = true;
                }
            }
            return sb.toString();
    ...
    public static ShapeType forId(int i, boolean z) {
        ...
        throw new IllegalArgumentException("Unknown shape type: " + i);
    }
}
