...
public class TOC {
    ...
    public TOC(CTSdtBlock cTSdtBlock) {
        ...
        addNewSdtPr.addNewId().setVal(BigInteger.valueOf(4844945));
        ...
        addNewRPr.addNewB().setVal(STOnOff1.OFF);
        addNewRPr.addNewBCs().setVal(STOnOff1.OFF);
        addNewRPr.addNewColor().setVal(DebugKt.DEBUG_PROPERTY_VALUE_AUTO);
        addNewRPr.addNewSz().setVal(BigInteger.valueOf(24));
        addNewRPr.addNewSzCs().setVal(BigInteger.valueOf(24));
        CTP addNewP = cTSdtBlock.addNewSdtContent().addNewP();
        addNewP.setRsidR("00EF7E24".getBytes(LocaleUtil.CHARSET_1252));
        addNewP.setRsidRDefault("00EF7E24".getBytes(LocaleUtil.CHARSET_1252));
    ...
    public void addRow(int i, String str, int i2, String str2) {
        ...
        addNewTab.setPos(BigInteger.valueOf(8290));
        ...
        addNewR6.addNewT().setStringValue(Integer.toString(i2));
