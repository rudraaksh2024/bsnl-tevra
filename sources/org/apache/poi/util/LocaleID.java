...
public enum LocaleID {
    ...
    ZH_SG(4100, "zh_sg", "zh-SG", "Chinese (Simplified, Singapore)", CodePageUtil.CP_GBK, 1),
    ...
    private static final Map<String, LocaleID> languageTagLookup = null;
    private static final Map<Integer, LocaleID> lcidLookup = null;
    ...
    static {
        languageTagLookup = (Map) Stream.of(values()).filter(new LocaleID$$ExternalSyntheticLambda0()).collect(Collectors.toMap(new LocaleID$$ExternalSyntheticLambda1(), Function.identity()));
        lcidLookup = (Map) Stream.of(values()).collect(Collectors.toMap(new LocaleID$$ExternalSyntheticLambda2(), Function.identity()));
    }

    private LocaleID(int i, String str, String str2, String str3, int i2, int i3) {
        this.lcid = i;
        this.windowsId = str;
        this.languageTag = str2;
        this.description = str3;
        this.defaultCodepage = i2;
        this.firstWeekday = i3 == -1 ? 2 : i3;
    }
