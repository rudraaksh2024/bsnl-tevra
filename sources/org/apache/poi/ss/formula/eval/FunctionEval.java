...
public final class FunctionEval {
    ...
    private static Function[] produceFunctions() {
        ...
        functionArr[8] = new FunctionEval$$ExternalSyntheticLambda0();
        functionArr[9] = new FunctionEval$$ExternalSyntheticLambda1();
        functionArr[10] = new FunctionEval$$ExternalSyntheticLambda2();
        ...
        functionArr[74] = new FunctionEval$$ExternalSyntheticLambda3();
        ...
        functionArr[221] = new FunctionEval$$ExternalSyntheticLambda4();
    ...
    public static void registerFunction(String str, Function function) {
        ...
        } else if (AnalysisToolPak.isATPFunction(str)) {
