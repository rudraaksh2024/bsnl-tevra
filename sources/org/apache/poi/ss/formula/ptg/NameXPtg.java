...
public final class NameXPtg extends OperandPtg implements WorkbookDependentFormula {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        return GenericRecordUtil.getGenericProperties("sheetRefIndex", new NameXPtg$$ExternalSyntheticLambda0(this), "nameIndex", new NameXPtg$$ExternalSyntheticLambda1(this));
    }
}
