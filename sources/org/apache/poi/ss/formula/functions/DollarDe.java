...
public final class DollarDe extends Fixed2ArgFunction implements FreeRefFunction {
    ...
    public ValueEval evaluate(int i, int i2, ValueEval valueEval, ValueEval valueEval2) {
        ...
        try {
            ...
            BigDecimal add = BigDecimal.valueOf(doubleValue).multiply(BigDecimal.valueOf(Math.pow(10.0d, (double) length))).divide(BigDecimal.valueOf((long) intValue), MathContext.DECIMAL128).add(BigDecimal.valueOf(longValue));
            if (z) {
