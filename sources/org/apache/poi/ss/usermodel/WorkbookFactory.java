...
public final class WorkbookFactory {
    ...
    private static class Singleton {
        ...
        public static final WorkbookFactory INSTANCE = new WorkbookFactory();
    ...
    private WorkbookFactory() {
        ...
        ServiceLoader.load(WorkbookProvider.class, WorkbookFactory.class.getClassLoader()).forEach(new WorkbookFactory$$ExternalSyntheticLambda0(arrayList));
    }

    public static Workbook create(boolean z) throws IOException {
        return wp(z ? FileMagic.OOXML : FileMagic.OLE2, new WorkbookFactory$$ExternalSyntheticLambda1());
    }
    ...
    public static Workbook create(DirectoryNode directoryNode, String str) throws IOException {
        if (directoryNode.hasEntry(Decryptor.DEFAULT_POIFS_ENTRY) || directoryNode.hasEntry(ExtractorFactory.OOXML_PACKAGE)) {
            return wp(FileMagic.OOXML, new WorkbookFactory$$ExternalSyntheticLambda6(directoryNode, str));
        }
        return wp(FileMagic.OLE2, new WorkbookFactory$$ExternalSyntheticLambda7(directoryNode, str));
    }
    ...
    public static Workbook create(InputStream inputStream, String str) throws IOException, EncryptedDocumentException {
        ...
        if (prepareToCheckMagic.read(new byte[1]) >= 1) {
            ...
            if (FileMagic.OOXML == valueOf) {
                return wp(valueOf, new WorkbookFactory$$ExternalSyntheticLambda4(prepareToCheckMagic));
            }
            if (FileMagic.OLE2 == valueOf) {
                ...
                return wp(valueOf, new WorkbookFactory$$ExternalSyntheticLambda5(root, str));
            }
    ...
    public static org.apache.poi.ss.usermodel.Workbook create(java.io.File r5, java.lang.String r6, boolean r7) throws java.io.IOException, org.apache.poi.EncryptedDocumentException {
        /*
            ...
            org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda2 r1 = new org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda2
            r1.<init>(r5, r6, r7)
            org.apache.poi.ss.usermodel.Workbook r5 = wp(r0, r1)
            return r5
        L_0x0022:
        ...
        L_0x0049:
            org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda3 r1 = new org.apache.poi.ss.usermodel.WorkbookFactory$$ExternalSyntheticLambda3
            r1.<init>(r5, r6, r7)
            org.apache.poi.ss.usermodel.Workbook r5 = wp(r0, r1)
            return r5
        L_0x0053:
        ...
        L_0x005f:
            ...
            java.lang.String r7 = "Can't open workbook - unsupported file type: "
            r6.<init>(r7)
    ...
    private static Workbook wp(FileMagic fileMagic, ProviderMethod providerMethod) throws IOException {
        for (WorkbookProvider next : Singleton.INSTANCE.provider) {
    ...
    public static void removeProvider(Class<? extends WorkbookProvider> cls) {
        Singleton.INSTANCE.provider.removeIf(new WorkbookFactory$$ExternalSyntheticLambda8(cls));
    }
}
