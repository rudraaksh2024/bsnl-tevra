...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public int readInt() {
        if (this.size >= 4) {
            ...
            int i2 = segment.limit;
            if (i2 - i < 4) {
                return (readByte() & UByte.MAX_VALUE) | ((readByte() & UByte.MAX_VALUE) << 24) | ((readByte() & UByte.MAX_VALUE) << UnionPtg.sid) | ((readByte() & UByte.MAX_VALUE) << 8);
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
            byte b = ((bArr[i] & UByte.MAX_VALUE) << 24) | ((bArr[i3] & UByte.MAX_VALUE) << UnionPtg.sid);
            int i5 = i4 + 1;
