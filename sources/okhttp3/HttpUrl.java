...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public Builder encodedPath(String str) {
            ...
            } else if (str.startsWith(PackagingURIHelper.FORWARD_SLASH_STRING)) {
            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    if (charAt == 65535 || charAt == c2 || charAt == '/' || charAt == '\\' || charAt == c) {
                        ...
                        if (charAt == '@') {
                            if (!z) {
                                int delimiterOffset2 = Util.delimiterOffset(str2, i2, delimiterOffset, (char) NameUtil.COLON);
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte((int) cArr[readByte & IntersectionPtg.sid]);
                    }
                } else {
                    buffer.writeUtf8CodePoint(codePointAt);
                }
