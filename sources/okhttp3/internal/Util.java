...
public final class Util {
    ...
    public static String hostHeader(HttpUrl httpUrl, boolean z) {
        ...
        return (z || httpUrl.port() != HttpUrl.defaultPort(httpUrl.scheme())) ? str + ParameterizedMessage.ERROR_MSG_SEPARATOR + httpUrl.port() : str;
    }
    ...
    private static String inet6AddressToAscii(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i) {
                ...
                buffer.writeHexadecimalUnsignedLong((long) (((bArr[i2] & UByte.MAX_VALUE) << 8) | (bArr[i2 + 1] & UByte.MAX_VALUE)));
                i2 += 2;
            }
        }
