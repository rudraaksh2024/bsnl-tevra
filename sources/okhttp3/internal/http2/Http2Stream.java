...
public final class Http2Stream {
    ...
    public synchronized boolean isOpen() {
        /*
            r2 = this;
            monitor-enter(r2)
            okhttp3.internal.http2.ErrorCode r0 = r2.errorCode     // Catch:{ all -> 0x0029 }
            r1 = 0
            if (r0 == 0) goto L_0x0008
            monitor-exit(r2)
            return r1
        L_0x0008:
            okhttp3.internal.http2.Http2Stream$FramingSource r0 = r2.source     // Catch:{ all -> 0x0029 }
            boolean r0 = r0.finished     // Catch:{ all -> 0x0029 }
            if (r0 != 0) goto L_0x0014
            okhttp3.internal.http2.Http2Stream$FramingSource r0 = r2.source     // Catch:{ all -> 0x0029 }
            boolean r0 = r0.closed     // Catch:{ all -> 0x0029 }
            if (r0 == 0) goto L_0x0026
        L_0x0014:
            okhttp3.internal.http2.Http2Stream$FramingSink r0 = r2.sink     // Catch:{ all -> 0x0029 }
            boolean r0 = r0.finished     // Catch:{ all -> 0x0029 }
            ...
            if (r0 == 0) goto L_0x0026
        L_0x0020:
            boolean r0 = r2.hasResponseHeaders     // Catch:{ all -> 0x0029 }
            if (r0 == 0) goto L_0x0026
            monitor-exit(r2)
            return r1
        L_0x0026:
