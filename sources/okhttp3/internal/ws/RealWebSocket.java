...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public synchronized boolean close(int r7, java.lang.String r8, long r9) {
        /*
            ...
            monitor-enter(r6)
            okhttp3.internal.ws.WebSocketProtocol.validateCloseCode(r7)     // Catch:{ all -> 0x004a }
            if (r8 == 0) goto L_0x002b
            okio.ByteString r1 = okio.ByteString.encodeUtf8(r8)     // Catch:{ all -> 0x004a }
            int r2 = r1.size()     // Catch:{ all -> 0x004a }
            ...
            goto L_0x002c
        L_0x0018:
            java.lang.IllegalArgumentException r7 = new java.lang.IllegalArgumentException     // Catch:{ all -> 0x004a }
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x004a }
            r9.<init>(r0)     // Catch:{ all -> 0x004a }
            java.lang.StringBuilder r8 = r9.append(r8)     // Catch:{ all -> 0x004a }
            java.lang.String r8 = r8.toString()     // Catch:{ all -> 0x004a }
            r7.<init>(r8)     // Catch:{ all -> 0x004a }
            throw r7     // Catch:{ all -> 0x004a }
        L_0x002b:
            r1 = 0
        L_0x002c:
            boolean r8 = r6.failed     // Catch:{ all -> 0x004a }
            if (r8 != 0) goto L_0x0047
            boolean r8 = r6.enqueuedClose     // Catch:{ all -> 0x004a }
            if (r8 == 0) goto L_0x0035
            goto L_0x0047
        L_0x0035:
            r8 = 1
            r6.enqueuedClose = r8     // Catch:{ all -> 0x004a }
            java.util.ArrayDeque<java.lang.Object> r0 = r6.messageAndCloseQueue     // Catch:{ all -> 0x004a }
            okhttp3.internal.ws.RealWebSocket$Close r2 = new okhttp3.internal.ws.RealWebSocket$Close     // Catch:{ all -> 0x004a }
            r2.<init>(r7, r1, r9)     // Catch:{ all -> 0x004a }
            r0.add(r2)     // Catch:{ all -> 0x004a }
            r6.runWriter()     // Catch:{ all -> 0x004a }
            monitor-exit(r6)
            return r8
        L_0x0047:
            monitor-exit(r6)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x005d, code lost:
        r1 = r3.data;
        r0 = okio.Okio.buffer(r0.newMessageSink(r3.formatOpcode, (long) r1.size()));
        r0.write(r1);
        r0.close();
     */
    ...
    public void writePingFrame() {
        ...
        L_0x0012:
            ...
            return
        L_0x0049:
            okio.ByteString r1 = okio.ByteString.EMPTY     // Catch:{ IOException -> 0x004f }
            r0.writePing(r1)     // Catch:{ IOException -> 0x004f }
            goto L_0x0053
        L_0x004f:
            r0 = move-exception
            r7.failWebSocket(r0, r3)
