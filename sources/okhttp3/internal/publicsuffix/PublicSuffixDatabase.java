...
public final class PublicSuffixDatabase {
    ...
    private static final byte[] WILDCARD_LABEL = {RefErrorPtg.sid};
    ...
    private void readTheListUninterruptibly() {
        /*
            ...
            r0 = 0
        L_0x0001:
            r4.readTheList()     // Catch:{ InterruptedIOException -> 0x0025, IOException -> 0x0010 }
        ...
        L_0x0010:
            r4 = move-exception
            okhttp3.internal.platform.Platform r1 = okhttp3.internal.platform.Platform.get()     // Catch:{ all -> 0x000e }
            java.lang.String r2 = "Failed to read public suffix list"
            r3 = 5
            r1.log(r3, r2, r4)     // Catch:{ all -> 0x000e }
