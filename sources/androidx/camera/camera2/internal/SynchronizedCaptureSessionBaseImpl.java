...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSessionOpener.OpenerImpl {
    ...
    public /* synthetic */ Object m59lambda$openCaptureSession$0$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(List list, CameraDeviceCompat cameraDeviceCompat, SessionConfigurationCompat sessionConfigurationCompat, CallbackToFutureAdapter.Completer completer) throws Exception {
        String str;
        synchronized (this.mLock) {
    ...
    public /* synthetic */ ListenableFuture m60lambda$startWithDeferrableSurface$1$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(List list, List list2) throws Exception {
    ...
    public /* synthetic */ void m56lambda$close$2$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl() {
    ...
    public /* synthetic */ void m57lambda$onClosed$3$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(SynchronizedCaptureSession synchronizedCaptureSession) {
    ...
    public /* synthetic */ void m58lambda$onSessionFinished$4$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(SynchronizedCaptureSession synchronizedCaptureSession) {
        Objects.requireNonNull(this.mCaptureSessionStateCallback);
