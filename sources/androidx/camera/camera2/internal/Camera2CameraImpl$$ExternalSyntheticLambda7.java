...
public final /* synthetic */ class Camera2CameraImpl$$ExternalSyntheticLambda7 implements Runnable {
    ...
    public /* synthetic */ Camera2CameraImpl$$ExternalSyntheticLambda7(Camera2CameraImpl camera2CameraImpl, String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig) {
    ...
    public final void run() {
        this.f$0.m21lambda$onUseCaseReset$8$androidxcameracamera2internalCamera2CameraImpl(this.f$1, this.f$2, this.f$3);
    }
}
