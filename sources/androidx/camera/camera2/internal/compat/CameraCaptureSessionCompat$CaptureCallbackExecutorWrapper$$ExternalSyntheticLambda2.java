...
public final /* synthetic */ class CameraCaptureSessionCompat$CaptureCallbackExecutorWrapper$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public final void run() {
        this.f$0.m78lambda$onCaptureSequenceCompleted$4$androidxcameracamera2internalcompatCameraCaptureSessionCompat$CaptureCallbackExecutorWrapper(this.f$1, this.f$2, this.f$3);
    }
}
