...
public abstract class CameraController {
    ...
    public /* synthetic */ Void m185lambda$new$0$androidxcameraviewCameraController(ProcessCameraProvider processCameraProvider) {
    ...
    public /* synthetic */ void m186lambda$new$1$androidxcameraviewCameraController(int i) {
    ...
    public /* synthetic */ void m188lambda$setEnabledUseCases$2$androidxcameraviewCameraController(int i) {
        this.mEnabledUseCases = i;
    }
    ...
    public void takePicture(ImageCapture.OutputFileOptions outputFileOptions, Executor executor, ImageCapture.OnImageSavedCallback onImageSavedCallback) {
        ...
        this.mImageCapture.m121lambda$takePicture$4$androidxcameracoreImageCapture(outputFileOptions, executor, onImageSavedCallback);
    }
    ...
    public void takePicture(Executor executor, ImageCapture.OnImageCapturedCallback onImageCapturedCallback) {
        ...
        Preconditions.checkState(isCameraInitialized(), CAMERA_NOT_INITIALIZED);
        Preconditions.checkState(isImageCaptureEnabled(), IMAGE_CAPTURE_DISABLED);
        this.mImageCapture.m120lambda$takePicture$3$androidxcameracoreImageCapture(executor, onImageCapturedCallback);
    }
    ...
    public void startRecording(OutputFileOptions outputFileOptions, Executor executor, final OnVideoSavedCallback onVideoSavedCallback) {
        ...
        this.mVideoCapture.m140lambda$startRecording$0$androidxcameracoreVideoCapture(outputFileOptions.toVideoCaptureOutputFileOptions(), executor, new VideoCapture.OnVideoSavedCallback() {
    ...
    public void stopRecording() {
        ...
        if (this.mVideoIsRecording.get()) {
            this.mVideoCapture.m144lambda$stopRecording$5$androidxcameracoreVideoCapture();
        }
    }
    ...
    public /* synthetic */ void m187lambda$setCameraSelector$3$androidxcameraviewCameraController(CameraSelector cameraSelector) {
        this.mCameraSelector = cameraSelector;
    }
