...
final class TextureViewImplementation extends PreviewViewImplementation {
    ...
    public /* synthetic */ void m199lambda$onSurfaceRequested$0$androidxcameraviewTextureViewImplementation(SurfaceRequest surfaceRequest) {
        SurfaceRequest surfaceRequest2 = this.mSurfaceRequest;
    ...
    public void initializePreview() {
        ...
        this.mTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
                ...
                PreviewView.OnFrameUpdateListener onFrameUpdateListener = TextureViewImplementation.this.mOnFrameUpdateListener;
                Executor executor = TextureViewImplementation.this.mFrameUpdateExecutor;
                if (onFrameUpdateListener != null && executor != null) {
                    executor.execute(new TextureViewImplementation$1$$ExternalSyntheticLambda0(onFrameUpdateListener, surfaceTexture));
                }
            }
        });
    ...
    public /* synthetic */ Object m200lambda$tryToProvidePreviewSurface$1$androidxcameraviewTextureViewImplementation(Surface surface, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m201lambda$tryToProvidePreviewSurface$2$androidxcameraviewTextureViewImplementation(Surface surface, ListenableFuture listenableFuture, SurfaceRequest surfaceRequest) {
    ...
    public /* synthetic */ Object m202lambda$waitForNextFrame$3$androidxcameraviewTextureViewImplementation(CallbackToFutureAdapter.Completer completer) throws Exception {
