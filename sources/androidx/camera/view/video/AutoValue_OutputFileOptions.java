...
final class AutoValue_OutputFileOptions extends OutputFileOptions {
    ...
    public String toString() {
        return "OutputFileOptions{file=" + this.file + ", fileDescriptor=" + this.fileDescriptor + ", contentResolver=" + this.contentResolver + ", saveCollection=" + this.saveCollection + ", contentValues=" + this.contentValues + ", metadata=" + this.metadata + VectorFormat.DEFAULT_SUFFIX;
    }
    ...
    public int hashCode() {
        ...
        return this.metadata.hashCode() ^ ((hashCode4 ^ i) * 1000003);
    }
