...
final class AutoValue_ImmutableImageInfo extends ImmutableImageInfo {
    ...
    public String toString() {
        return "ImmutableImageInfo{tagBundle=" + this.tagBundle + ", timestamp=" + this.timestamp + ", rotationDegrees=" + this.rotationDegrees + ", sensorToBufferTransformMatrix=" + this.sensorToBufferTransformMatrix + VectorFormat.DEFAULT_SUFFIX;
    }
    ...
    public int hashCode() {
        ...
        return this.sensorToBufferTransformMatrix.hashCode() ^ ((((((this.tagBundle.hashCode() ^ 1000003) * 1000003) ^ ((int) (j ^ (j >>> 32)))) * 1000003) ^ this.rotationDegrees) * 1000003);
    }
}
