...
class AndroidImageReaderProxy implements ImageReaderProxy {
    ...
    public /* synthetic */ void m104lambda$setOnImageAvailableListener$1$androidxcameracoreAndroidImageReaderProxy(Executor executor, ImageReaderProxy.OnImageAvailableListener onImageAvailableListener, ImageReader imageReader) {
        synchronized (this.mLock) {
    ...
    public /* synthetic */ void m103lambda$setOnImageAvailableListener$0$androidxcameracoreAndroidImageReaderProxy(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
