...
final class ImageAnalysisNonBlockingAnalyzer extends ImageAnalysisAbstractAnalyzer {
    ...
    public void onValidImageAvailable(androidx.camera.core.ImageProxy r6) {
        ...
        L_0x0035:
            ...
            java.util.concurrent.Executor r5 = androidx.camera.core.impl.utils.executor.CameraXExecutors.directExecutor()     // Catch:{ all -> 0x004e }
            androidx.camera.core.impl.utils.futures.Futures.addCallback(r6, r2, r5)     // Catch:{ all -> 0x004e }
            monitor-exit(r0)     // Catch:{ all -> 0x004e }
            return
        L_0x004e:
            r5 = move-exception
    ...
    static class CacheAnalyzingImageProxy extends ForwardingImageProxy {
        ...
        public /* synthetic */ void m116lambda$new$1$androidxcameracoreImageAnalysisNonBlockingAnalyzer$CacheAnalyzingImageProxy(ImageProxy imageProxy) {
