...
public final class SurfaceRequest {
    ...
    public SurfaceRequest(Size size, CameraInternal cameraInternal, boolean z) {
        this(size, cameraInternal, z, (Range<Integer>) null);
    }
    ...
    public SurfaceRequest(Size size, CameraInternal cameraInternal, boolean z, Range<Integer> range) {
        ...
        AnonymousClass2 r0 = new DeferrableSurface(size, 34) {
        ...
        terminationFuture.addListener(new SurfaceRequest$$ExternalSyntheticLambda3(this), CameraXExecutors.directExecutor());
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$new$3$androidx-camera-core-SurfaceRequest  reason: not valid java name */
    public /* synthetic */ void m138lambda$new$3$androidxcameracoreSurfaceRequest() {
