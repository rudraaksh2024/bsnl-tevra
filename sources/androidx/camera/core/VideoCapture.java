...
public final class VideoCapture extends UseCase {
    ...
    public void m140lambda$startRecording$0$androidxcameracoreVideoCapture(OutputFileOptions outputFileOptions, Executor executor, OnVideoSavedCallback onVideoSavedCallback) {
    ...
    public /* synthetic */ void m141lambda$startRecording$2$androidxcameracoreVideoCapture() {
    ...
    public /* synthetic */ void m143lambda$startRecording$4$androidxcameracoreVideoCapture(OnVideoSavedCallback onVideoSavedCallback, String str, Size size, OutputFileOptions outputFileOptions, CallbackToFutureAdapter.Completer completer) {
    ...
    public void m144lambda$stopRecording$5$androidxcameracoreVideoCapture() {
        if (Looper.getMainLooper() != Looper.myLooper()) {
    ...
    public void onDetached() {
        m144lambda$stopRecording$5$androidxcameracoreVideoCapture();
        ...
        if (listenableFuture != null) {
            ...
            m139lambda$onDetached$6$androidxcameracoreVideoCapture();
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: releaseResources */
    public void m139lambda$onDetached$6$androidxcameracoreVideoCapture() {
    ...
    public boolean m142lambda$startRecording$3$androidxcameracoreVideoCapture(OnVideoSavedCallback onVideoSavedCallback) {
    ...
    private static final class VideoSavedListenerWrapper implements OnVideoSavedCallback {
        ...
        public /* synthetic */ void m146lambda$onVideoSaved$0$androidxcameracoreVideoCapture$VideoSavedListenerWrapper(OutputFileResults outputFileResults) {
        ...
        public /* synthetic */ void m145lambda$onError$1$androidxcameracoreVideoCapture$VideoSavedListenerWrapper(int i, String str, Throwable th) {
