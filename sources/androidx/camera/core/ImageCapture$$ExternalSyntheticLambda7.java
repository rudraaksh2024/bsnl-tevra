...
public final /* synthetic */ class ImageCapture$$ExternalSyntheticLambda7 implements Runnable {
    ...
    public /* synthetic */ ImageCapture$$ExternalSyntheticLambda7(ImageCapture imageCapture, ImageCapture.OutputFileOptions outputFileOptions, Executor executor, ImageCapture.OnImageSavedCallback onImageSavedCallback) {
    ...
    public final void run() {
        this.f$0.m121lambda$takePicture$4$androidxcameracoreImageCapture(this.f$1, this.f$2, this.f$3);
    }
}
