...
public final /* synthetic */ class DefaultSurfaceProcessor$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ DefaultSurfaceProcessor$$ExternalSyntheticLambda1(DefaultSurfaceProcessor defaultSurfaceProcessor, SurfaceOutput surfaceOutput) {
        this.f$0 = defaultSurfaceProcessor;
        this.f$1 = surfaceOutput;
    }

    public final void run() {
        this.f$0.m173lambda$onOutputSurface$3$androidxcameracoreprocessingDefaultSurfaceProcessor(this.f$1);
    }
}
