...
public final /* synthetic */ class DeferrableSurfaces$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ DeferrableSurfaces$$ExternalSyntheticLambda1(Executor executor, ListenableFuture listenableFuture, CallbackToFutureAdapter.Completer completer, long j) {
        this.f$0 = executor;
    ...
    public final void run() {
        this.f$0.execute(new DeferrableSurfaces$$ExternalSyntheticLambda0(this.f$1, this.f$2, this.f$3));
    }
}
