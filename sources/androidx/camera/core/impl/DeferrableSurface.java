...
public abstract class DeferrableSurface {
    ...
    public /* synthetic */ Object m159lambda$new$0$androidxcameracoreimplDeferrableSurface(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m160lambda$new$1$androidxcameracoreimplDeferrableSurface(String str) {
        try {
    ...
    private void printGlobalDebugCounts(String str, int i, int i2) {
        ...
        Logger.d(TAG, str + "[total_surfaces=" + i + ", used_surfaces=" + i2 + "](" + this + VectorFormat.DEFAULT_SUFFIX);
    }
