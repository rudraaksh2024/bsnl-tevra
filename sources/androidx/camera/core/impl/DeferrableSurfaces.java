...
public final class DeferrableSurfaces {
    ...
    public static ListenableFuture<List<Surface>> surfaceListWithTimeout(Collection<DeferrableSurface> collection, boolean z, long j, Executor executor, ScheduledExecutorService scheduledExecutorService) {
        ...
        return CallbackToFutureAdapter.getFuture(new DeferrableSurfaces$$ExternalSyntheticLambda3(arrayList, scheduledExecutorService, executor, j, z));
    }
    ...
    static /* synthetic */ Object lambda$surfaceListWithTimeout$3(List list, ScheduledExecutorService scheduledExecutorService, Executor executor, long j, final boolean z, final CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        final ScheduledFuture<?> schedule = scheduledExecutorService.schedule(new DeferrableSurfaces$$ExternalSyntheticLambda1(executor, successfulAsList, completer, j), j, TimeUnit.MILLISECONDS);
        completer.addCancellationListener(new DeferrableSurfaces$$ExternalSyntheticLambda2(successfulAsList), executor);
