...
class ListFuture<V> implements ListenableFuture<List<V>> {
    ...
    public void setOneValue(int r7, java.util.concurrent.Future<? extends V> r8) {
        ...
        L_0x002a:
            ...
            androidx.concurrent.futures.CallbackToFutureAdapter$Completer<java.util.List<V>> r6 = r6.mResultNotifier
        ...
        L_0x003f:
            ...
            androidx.core.util.Preconditions.checkState(r6)
            goto L_0x00dd
        L_0x0048:
            r7 = move-exception
            goto L_0x00de
        ...
        L_0x0103:
            throw r7
        L_0x0104:
            boolean r6 = r6.mAllMustSucceed
            java.lang.String r7 = "Future was done before all dependencies completed"
            androidx.core.util.Preconditions.checkState(r6, r7)
            return
        */
