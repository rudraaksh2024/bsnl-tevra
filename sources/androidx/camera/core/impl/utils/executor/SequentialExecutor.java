...
final class SequentialExecutor implements Executor {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0058, code lost:
        if (r7.mWorkerRunningState == androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.IDLE) goto L_0x0060;
     */
    ...
    public void execute(final java.lang.Runnable r8) {
        /*
            ...
            monitor-enter(r0)
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r1 = r7.mWorkerRunningState     // Catch:{ all -> 0x007d }
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r2 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.RUNNING     // Catch:{ all -> 0x007d }
            if (r1 == r2) goto L_0x0076
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r1 = r7.mWorkerRunningState     // Catch:{ all -> 0x007d }
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r2 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.QUEUED     // Catch:{ all -> 0x007d }
            if (r1 != r2) goto L_0x0013
            goto L_0x0076
        L_0x0013:
            long r1 = r7.mWorkerRunCount     // Catch:{ all -> 0x007d }
            androidx.camera.core.impl.utils.executor.SequentialExecutor$1 r3 = new androidx.camera.core.impl.utils.executor.SequentialExecutor$1     // Catch:{ all -> 0x007d }
            r3.<init>(r8)     // Catch:{ all -> 0x007d }
            java.util.Deque<java.lang.Runnable> r8 = r7.mQueue     // Catch:{ all -> 0x007d }
            r8.add(r3)     // Catch:{ all -> 0x007d }
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r8 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.QUEUING     // Catch:{ all -> 0x007d }
            r7.mWorkerRunningState = r8     // Catch:{ all -> 0x007d }
            monitor-exit(r0)     // Catch:{ all -> 0x007d }
            r8 = 1
            r0 = 0
            java.util.concurrent.Executor r4 = r7.mExecutor     // Catch:{ Error | RuntimeException -> 0x0050 }
            androidx.camera.core.impl.utils.executor.SequentialExecutor$QueueWorker r5 = r7.mWorker     // Catch:{ Error | RuntimeException -> 0x0050 }
            r4.execute(r5)     // Catch:{ Error | RuntimeException -> 0x0050 }
        ...
        L_0x0050:
            ...
            monitor-enter(r2)
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r4 = r7.mWorkerRunningState     // Catch:{ all -> 0x0073 }
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r5 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.IDLE     // Catch:{ all -> 0x0073 }
            if (r4 == r5) goto L_0x0060
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r4 = r7.mWorkerRunningState     // Catch:{ all -> 0x0073 }
            androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r5 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.QUEUING     // Catch:{ all -> 0x0073 }
            if (r4 != r5) goto L_0x0069
        L_0x0060:
            java.util.Deque<java.lang.Runnable> r7 = r7.mQueue     // Catch:{ all -> 0x0073 }
            boolean r7 = r7.removeLastOccurrence(r3)     // Catch:{ all -> 0x0073 }
            if (r7 == 0) goto L_0x0069
            goto L_0x006a
        L_0x0069:
            r8 = r0
        L_0x006a:
            boolean r7 = r1 instanceof java.util.concurrent.RejectedExecutionException     // Catch:{ all -> 0x0073 }
        ...
        L_0x0073:
            ...
            throw r7
        L_0x0076:
            java.util.Deque<java.lang.Runnable> r7 = r7.mQueue     // Catch:{ all -> 0x007d }
            r7.add(r8)     // Catch:{ all -> 0x007d }
            monitor-exit(r0)     // Catch:{ all -> 0x007d }
            return
        L_0x007d:
            r7 = move-exception
    ...
    final class QueueWorker implements Runnable {
        ...
        private void workOnQueue() {
            ...
            L_0x0002:
                ...
                androidx.camera.core.impl.utils.executor.SequentialExecutor r0 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x006d }
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r0 = r0.mWorkerRunningState     // Catch:{ all -> 0x006d }
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r3 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.RUNNING     // Catch:{ all -> 0x006d }
            ...
            L_0x001c:
                androidx.camera.core.impl.utils.executor.SequentialExecutor r0 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x006d }
                long r3 = r0.mWorkerRunCount     // Catch:{ all -> 0x006d }
                r5 = 1
                long r3 = r3 + r5
                r0.mWorkerRunCount = r3     // Catch:{ all -> 0x006d }
                androidx.camera.core.impl.utils.executor.SequentialExecutor r0 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x006d }
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r3 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.RUNNING     // Catch:{ all -> 0x006d }
                r0.mWorkerRunningState = r3     // Catch:{ all -> 0x006d }
                r0 = 1
            L_0x002c:
                ...
                androidx.camera.core.impl.utils.executor.SequentialExecutor r7 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x006d }
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r0 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.IDLE     // Catch:{ all -> 0x006d }
                r7.mWorkerRunningState = r0     // Catch:{ all -> 0x006d }
                monitor-exit(r2)     // Catch:{ all -> 0x006d }
            ...
            L_0x0053:
                ...
                java.lang.StringBuilder r3 = r5.append(r3)     // Catch:{ all -> 0x0070 }
                java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0070 }
                androidx.camera.core.Logger.e(r4, r3, r2)     // Catch:{ all -> 0x0070 }
                goto L_0x0002
            L_0x006d:
                r7 = move-exception
                monitor-exit(r2)     // Catch:{ all -> 0x006d }
