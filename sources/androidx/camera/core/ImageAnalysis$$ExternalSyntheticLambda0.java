...
public final /* synthetic */ class ImageAnalysis$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ ImageAnalysis$$ExternalSyntheticLambda0(SafeCloseImageReaderProxy safeCloseImageReaderProxy, SafeCloseImageReaderProxy safeCloseImageReaderProxy2) {
        this.f$0 = safeCloseImageReaderProxy;
        this.f$1 = safeCloseImageReaderProxy2;
    }

    public final void run() {
        ImageAnalysis.lambda$createPipeline$0(this.f$0, this.f$1);
    }
}
