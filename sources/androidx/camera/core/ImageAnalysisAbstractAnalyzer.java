...
abstract class ImageAnalysisAbstractAnalyzer implements ImageReaderProxy.OnImageAvailableListener {
    ...
    com.google.common.util.concurrent.ListenableFuture<java.lang.Void> analyzeImage(androidx.camera.core.ImageProxy r15) {
        ...
        L_0x0095:
            ...
            com.google.common.util.concurrent.ListenableFuture r14 = androidx.concurrent.futures.CallbackToFutureAdapter.getFuture(r0)
            goto L_0x00bf
        L_0x00b1:
            r14 = move-exception
            monitor-exit(r3)     // Catch:{ all -> 0x00b1 }
            throw r14
        L_0x00b4:
            androidx.core.os.OperationCanceledException r14 = new androidx.core.os.OperationCanceledException
            java.lang.String r15 = "No analyzer or executor currently set."
            r14.<init>(r15)
            com.google.common.util.concurrent.ListenableFuture r14 = androidx.camera.core.impl.utils.futures.Futures.immediateFailedFuture(r14)
        L_0x00bf:
            return r14
        L_0x00c0:
            r14 = move-exception
    ...
    public /* synthetic */ Object m115lambda$analyzeImage$1$androidxcameracoreImageAnalysisAbstractAnalyzer(Executor executor, ImageProxy imageProxy, Matrix matrix, ImageProxy imageProxy2, Rect rect, ImageAnalysis.Analyzer analyzer, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m114lambda$analyzeImage$0$androidxcameracoreImageAnalysisAbstractAnalyzer(ImageProxy imageProxy, Matrix matrix, ImageProxy imageProxy2, Rect rect, ImageAnalysis.Analyzer analyzer, CallbackToFutureAdapter.Completer completer) {
        int i;
        if (this.mIsAttached) {
