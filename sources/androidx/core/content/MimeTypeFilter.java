...
public final class MimeTypeFilter {
    ...
    public static String matches(String str, String[] strArr) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(split, str2.split(PackagingURIHelper.FORWARD_SLASH_STRING))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(String[] strArr, String str) {
        ...
        String[] split = str.split(PackagingURIHelper.FORWARD_SLASH_STRING);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(PackagingURIHelper.FORWARD_SLASH_STRING), split)) {
                return str2;
            }
        }
        return null;
