...
public final class ContentInfoCompat {
    ...
    private static final class CompatImpl implements Compat {
        ...
        public String toString() {
            String str = "";
            StringBuilder append = new StringBuilder("ContentInfoCompat{clip=").append(this.mClip.getDescription()).append(", source=").append(ContentInfoCompat.sourceToString(this.mSource)).append(", flags=").append(ContentInfoCompat.flagsToString(this.mFlags)).append(this.mLinkUri == null ? str : ", hasLinkUri(" + this.mLinkUri.toString().length() + ")");
            if (this.mExtras != null) {
                str = ", hasExtras";
            }
            return append.append(str).append(VectorFormat.DEFAULT_SUFFIX).toString();
        }
    }
