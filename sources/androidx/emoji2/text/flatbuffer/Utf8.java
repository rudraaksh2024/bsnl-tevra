...
public abstract class Utf8 {
    ...
    static class DecodeUtil {
        ...
        private static char lowSurrogate(int i) {
            return (char) ((i & IEEEDouble.EXPONENT_BIAS) + 56320);
        }
        ...
        static void handleTwoBytes(byte b, byte b2, char[] cArr, int i) throws IllegalArgumentException {
            if (b < -62) {
                ...
                cArr[i] = (char) (((b & NumberPtg.sid) << 6) | trailingByteValue(b2));
            } else {
        ...
        static void handleThreeBytes(byte b, byte b2, byte b3, char[] cArr, int i) throws IllegalArgumentException {
            ...
            cArr[i] = (char) (((b & IntersectionPtg.sid) << 12) | (trailingByteValue(b2) << 6) | trailingByteValue(b3));
        }
        ...
        static void handleFourBytes(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws IllegalArgumentException {
            ...
            int trailingByteValue = ((b & 7) << UnaryPlusPtg.sid) | (trailingByteValue(b2) << 12) | (trailingByteValue(b3) << 6) | trailingByteValue(b4);
