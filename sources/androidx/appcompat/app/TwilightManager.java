...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - DateUtil.DAY_MILLISECONDS, location.getLatitude(), location.getLongitude());
        ...
        long j6 = j3;
        instance.calculateTwilight(currentTimeMillis + DateUtil.DAY_MILLISECONDS, location.getLatitude(), location.getLongitude());
