...
public class LinearSystem {
    ...
    public void displaySystemInformation() {
        ...
        printStream.println(append.append(getDisplaySize(i5 * i5)).append(") -- row sizes: ").append(getDisplaySize(i)).append(", actual size: ").append(getDisplaySize(i3)).append(" rows: ").append(this.mNumRows).append(PackagingURIHelper.FORWARD_SLASH_STRING).append(this.mMaxRows).append(" cols: ").append(this.mNumColumns).append(PackagingURIHelper.FORWARD_SLASH_STRING).append(this.mMaxColumns).append(" 0 occupied cells, ").append(getDisplaySize(0)).toString());
    }
