...
public class LifecycleRegistry extends Lifecycle {
    ...
    private final androidx.lifecycle.Lifecycle.State calculateTargetState(androidx.lifecycle.LifecycleObserver r3) {
        /*
            r2 = this;
            androidx.arch.core.internal.FastSafeIterableMap<androidx.lifecycle.LifecycleObserver, androidx.lifecycle.LifecycleRegistry$ObserverWithState> r0 = r2.observerMap
        ...
        L_0x0031:
            ...
            androidx.lifecycle.Lifecycle$State r2 = r1.min$lifecycle_runtime_release(r2, r3)
            androidx.lifecycle.Lifecycle$State r2 = r1.min$lifecycle_runtime_release(r2, r0)
            return r2
        */
