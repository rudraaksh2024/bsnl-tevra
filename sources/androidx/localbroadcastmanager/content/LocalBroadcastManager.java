...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(android.content.Intent r23) {
        /*
            ...
            android.content.Context r5 = r0.mAppContext     // Catch:{ all -> 0x0176 }
            android.content.ContentResolver r5 = r5.getContentResolver()     // Catch:{ all -> 0x0176 }
            java.lang.String r13 = r1.resolveTypeIfNeeded(r5)     // Catch:{ all -> 0x0176 }
        ...
        L_0x0034:
            ...
            java.lang.StringBuilder r3 = r3.append(r6)     // Catch:{ all -> 0x0176 }
            java.lang.StringBuilder r3 = r3.append(r1)     // Catch:{ all -> 0x0176 }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0176 }
            android.util.Log.v(r5, r3)     // Catch:{ all -> 0x0176 }
        L_0x005c:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r3 = r0.mActions     // Catch:{ all -> 0x0176 }
        ...
        L_0x0146:
            ...
            goto L_0x0146
        L_0x0158:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r3 = r0.mPendingBroadcasts     // Catch:{ all -> 0x0176 }
            ...
            r5.<init>(r1, r2)     // Catch:{ all -> 0x0176 }
            r3.add(r5)     // Catch:{ all -> 0x0176 }
            android.os.Handler r1 = r0.mHandler     // Catch:{ all -> 0x0176 }
            boolean r1 = r1.hasMessages(r12)     // Catch:{ all -> 0x0176 }
            if (r1 != 0) goto L_0x016f
            android.os.Handler r0 = r0.mHandler     // Catch:{ all -> 0x0176 }
